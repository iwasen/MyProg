...
<table width="680" border="0" cellspacing="0" cellpadding="0">
	<tr>
		...
		<td width="400" valign="top"><font size="3" class="honbun1">≪受信者プロファイル≫</font></td>
	</tr>
</table>
			<table width="680" border="0" cellspacing="0" cellpadding="0">
				<tr>
			...
			<table width="680" border="1" cellspacing="0" cellpadding="5" bordercolor="#c0c0c0" bordercolorlight="#c0c0c0" bordercolordark="#c0c0c0" frame="box">
				<tr bgcolor="#eeeeee">
					...
					<td nowrap><font size="2" class="honbun2">回答日</font></td>
...
$sql = "SELECT an_date,mn_sex,DATE_PART('Y',AGE($start_date,mn_birthday)) AS mn_age,mn_mikikon,mn_child,ar_area_name AS jitaku_area_name,sg_shokugyou_name"
		. " FROM t_enquete_list"
...
?>
				<tr bgcolor="#ffffff">
					...
					<td nowrap><font size="2" class="honbun2"><?=format_date($fetch->an_date)?></font></td>
