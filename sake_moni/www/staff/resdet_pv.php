...
<table width="720" border="0" cellspacing="0" cellpadding="0">
	<tr>
		...
		<td align="right">
			<input type="button" value="集計結果のダウンロード" onclick="location.href='csv_age_sex.php?enquete_id=<?=$enquete_id?>'">
		</td>
	</tr>
</table>
<table width="720" border="0" cellspacing="0" cellpadding="0">
			...
			<table width="580" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td align="right">
						...
						<a href="resdet_sex.php?enquete_id=<?=$enquete_id?>">性別</a>　｜　<a href="resdet_age.php?enquete_id=<?=$enquete_id?>">年代</a>　｜　<a href="resdet_sex_age.php?enquete_id=<?=$enquete_id?>">性別・年代（１０歳毎）</a>　｜　<strong>年代（５歳毎）・性別</strong>　｜　<a href="enqdet1.php?enquete_id=<?=$enquete_id?>">アンケート詳細表示に戻る</a></font>
					</td>
				</tr>
			</table>
			<br><br>
...
?>
				...
				<tr>
					<td align="center" colspan="2"><font size="2" class="honbun2">全体</font></td>
<?
				for ($tno = 1; $tno <= MAX_SEL; $tno++) {
...
?>
					<td width="40" align="center"><font size="2" class="honbun2"><?=number_format($cnt[$age][$sex][$sel_no])?><br><?=format_percent($cnt[$age][$sex][$sel_no], $num[$age][$sex])?></font></td>
<?
							} else {
?>
					<td><br></td>
...
?>
					<td width="40" align="center"><font size="2" class="honbun2"><?=number_format($num[$age][$sex])?><br>100%</font></td>
				</tr>
<?
					}
				}
...
?>
								<font size="2" class="honbun2"><a href="resdet_fa.php?enquete_id=<?=$enquete_id?>&question_no=<?=$question_no?>&sel_no=<?=$sel_no?>&type=age_sex" target="_blank" title="新しいウィンドウで定性回答を表示します"><?=$sno?>．<?=htmlspecialchars($sel_text)?></a></font>
<?
					} else {
?>
...
?>
							<tr>
								<td width="100"></td>
								<td align="right"><br><font size="2" class="honbun2"><a href="resdet_fa.php?enquete_id=<?=$enquete_id?>&question_no=<?=$question_no?>&sel_no=0&type=age_sex" target="_blank" title="新しいウィンドウで定性回答の一覧を表示します">Ｑ<?=$qno?>の回答はこちら</a></font></td>
							</tr>
<?
			}
?>
