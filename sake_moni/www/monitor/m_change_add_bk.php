...
if ($_POST['edit']) {
	...
	$sql = "SELECT mn_mail_addr,mn_jitaku_zip,mn_jitaku_area,mn_jitaku_addr2,mn_net_kind,mn_payment_type,mn_account_num FROM t_monitor WHERE mn_monitor_id=$monitor_id";
	$result = db_exec($sql);
