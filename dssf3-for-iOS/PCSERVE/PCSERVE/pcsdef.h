...
#define	ERROR_SERVER_MAXCONxxxT	1006	/* コネクト数オーバ */
#define	ERROR_SERVER_CONxxxT	1007	/* 二重化の相手のサーバに接続できない*/
...
#define	ERROR_CLIENT_CONxxxT	2006	/* conxxxt() エラー */
...
#define	ERROR_CLIENT_MAXCONxxxT	2013	/* コネクト数オーバ */
#define	ERROR_CLIENT_WINSOCK	2014	/* winsock.dll がロードできない */
#define	ERROR_CLIENT_NOTCONxxxT	2015	/* サーバに接続していません */
