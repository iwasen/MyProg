...
Namespace DataGridTextBoxCombo
    ...
    Public Class DataGridComboBoxColumn
        ...
        Private SelectTable As New DataTable()
        ...
        Public Sub New()
            ...
            SelectTable.Columns.Add("DisplayValue")
            SelectTable.Columns.Add("SelectedValue")
            ColumnComboBox.DataSource = SelectTable.DefaultView
            ColumnComboBox.DisplayMember = "DisplayValue"
            ColumnComboBox.ValueMember = "SelectedValue"
        ...
        Protected Overloads Overrides Sub Edit(ByVal [source] As System.Windows.Forms.CurrencyManager, ByVal rowNum As Integer, ByVal bounds As System.Drawing.Rectangle, ByVal [readOnly] As Boolean, ByVal instantText As String, ByVal cellIsVisible As Boolean)
            ...
            ColumnComboBox.Location = New Point(Me.TextBox.Location.X, Me.TextBox.Location.Y - 3)
        ...
        Public Sub AddList(ByVal DisplayValue As String, ByVal SelectValue As String)
            Dim row As DataRow

            row = SelectTable.NewRow()
            row("DisplayValue") = DisplayValue
            row("SelectedValue") = SelectValue
