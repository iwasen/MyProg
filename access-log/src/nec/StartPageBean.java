 ...
 * 閲覧開始ページランキングを作成
 */
public class StartPageBean implements I_Access_Page {
  ...
  public void searchDB(DataBase db, SelectCondBean selectcondBean) {
    try {
      ...
      q01.append("and SSIO_PATTEN_FLG='F' \n");
      if (selectcondBean.getGroup().length() != 0)
        q01.append("and SSIO_CORNERCODE_CODE like '" + selectcondBean.getGroupCorner(db) + "%'");
