...
<html>
    ...
    <td align="right" valign="top"> <img height="16" width="50" src="../img/space.gif"></td>
				<td align="left" valign="top"><font color="#2f2180"><b>仮登録が完了しました。<br>
					<br>
					...
					<br>
					<br>
					<img src=http://tool.cafesta.com/gsp_page_end.cgi?c_code=gsp_0015  border=0  width=1  height=1>
					<br>
					<br>
					<br>
					</font></td>
			...
			<tr height="22" align="left" valign="middle">
				...
				<td height="22">
					<div align="left">
						<hr>
						<a href="../index.php"><img height="17" width="80" src="../img/home_b.gif" border="0" alt="ホームに戻る"></a></div>
				</td>
			</tr>
		</table>
	</body>
