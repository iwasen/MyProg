		...
		<table cellspacing="0" cellpadding="0" border="0" width="596">
			<tr>
				...
				<td width="546"><table border="0" cellspacing="0" width="546">
						<form name="FormName" action="6-3.php" method="post">
						<tr height="36">
						...
						<tr>
							<td align="left" valign="top"><table width="545" border="0" cellspacing="0" height="33">
									<tr>
										<td align="left" valign="top"><font size="2">こちらに、はいめーるレターをお送りしてよろしければ、「送信」ボタンを押してください。<br>
											</font></td>
									</tr>
									...
									<tr height="20">
										...
										<td width="243" height="20"><font size="2"><?=ReplaceTag($h_letter->mail_adr)?></font></td>
									</tr>
									<tr>
										<td width="140"></td>
										<td width="243"><br>
