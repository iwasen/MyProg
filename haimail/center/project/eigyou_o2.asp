			...
			<td>
				<table border=0 cellspacing=2 cellpadding=3 width="100%">
					...
					<tr>
						...
						<td class="n3">
							<font class="note">姓</font><input size=20 name="name1_kana" maxlength=10 value="<%=HTMLEncode(ds("OP_name1_kana").Value)%>">
							<font class="note">名</font><input size=20 name="name2_kana" maxlength=10 value="<%=HTMLEncode(ds("OP_name2_kana").Value)%>">
