...
Private Sub ReadJob(id)
	...
	sql = "SELECT * FROM T_BSHAISHIN,T_SEND_MAIL" & vbCrLf & _
				"WHERE BH_job_id=" & id & " AND BH_mail_id=SM_mail_id(+)"
...
'=== メイン処理 ===
SetHeaderTitle "ビジネス配信 原稿＆発信条件登録"
...
<center>
<form method="post" action="bh_mail2.asp" name="form1">
		...
		<tr>
			<td>
				<table border=0 cellspacing=2 cellpadding=3 width="100%">
					...
					<tr>
						<td class="m3">原稿</td>
						<td class="n3"><textarea name="body" cols=78 rows=20 class="np"><%=body%></textarea></td>
					</tr>
					<tr>
