...
sql = "ZH_job_id=" & job_id & " AND RM_imp_valid='1'"
...
If Request.Form("midoku") = "1" Then
	AndJoin sql, "RM_seq_no NOT IN (SELECT MR_recv_mail FROM T_MAIL_READ WHERE MR_login_type='" & g_login_type & "' AND MR_login_id='" & g_login_id & "' AND MR_enq_imp='I')"
End If
...
Do Until ds.EOF
	...
	Writeln "<td><a href='imp_list2.asp?seq=" & seq & "&id=" & ds("RM_seq_no").Value & "' title='感想文レスポンスを表示します'>" & ReplaceTag(subject) & "</a></td>"
