...
sql = "SELECT CM_company_id, CM_name, COUNT(PJ_project_id) AS PJ_count, SUM(SR_count) AS SR_count, SUM(RM_enq_count) AS RM_enq_count, SUM(CC_count) AS CC_count, SUM(RM_imp_count) RM_imp_count" & vbCrLf & _
			"FROM T_PROJECT, T_JOB, T_SEND_MAIL, T_TANTOUSHA, T_COMPANY,(" & sub1 & "),(" & sub2 & "),(" & sub3 & ")" & vbCrLf & _
			...
			"AND TO_CHAR(SM_start_date,'YYYYMM') = '" & s_ym & "'" & vbCrLf & _
