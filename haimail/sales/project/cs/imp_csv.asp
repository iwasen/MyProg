...
<form method="post" name="form1">
	...
	<br>
	<input type="button" value="データ取得" onclick="location.href='imp_csv_data.asp?job_id=<%=job_id%>'">
	<input type="button" value="日別推移" onclick="location.href='imp_csv_day.asp?job_id=<%=job_id%>'">
	<input type="button" value="時間別推移" onclick="location.href='imp_csv_time.asp?job_id=<%=job_id%>'">
	<input type="button" value="日別時間別推移" onclick="location.href='imp_csv_daytime.asp?job_id=<%=job_id%>'">
	<input type="button" value=" 戻る " onclick="location.href='impression.asp?job_id=<%=job_id%>'">
</form>
</center>
