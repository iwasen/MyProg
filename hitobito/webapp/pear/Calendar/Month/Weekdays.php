...
// +----------------------------------------------------------------------+
//
// $Id: Weekdays.php,v 1.1 2005/12/25 21:50:40 ryu Exp $
//
/**
 * @package Calendar
 * @version $Id: Weekdays.php,v 1.1 2005/12/25 21:50:40 ryu Exp $
 */
...
class Calendar_Month_Weekdays extends Calendar_Month
{
    ...
    /**
     * Shifts the array of children forward, if xxxessary
     * @return void
     * @access private
     */
    function shiftDays()
