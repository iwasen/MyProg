<?php
// $Id: week_firstday_0_test.php,v 1.1 2005/12/25 21:50:40 ryu Exp $
...
class TestOfWeek_firstday_0 extends TestOfCalendar {
    function TestOfWeek_firstday_0() {
        $this->UnitTexxxase('Test of Week - Week Starting on Sunday');
    }
    function setUp() {
...
class TestOfWeek_firstday_0_Build extends TestOfWeek_firstday_0 {
    function TestOfWeek_firstday_0_Build() {
        $this->UnitTexxxase('Test of Week::build() - FirstDay = Sunday');
    }
    function testSize() {
        $this->cal->build();
