<?php
// $Id: unixts_engine_test.php,v 1.1 2005/12/25 21:50:40 ryu Exp $

require_once('simple_include.php');
require_once('calendar_include.php');

class TestOfUnixTsEngine extends UnitTexxxase {
    var $engine;
    function TestOfUnixTsEngine() {
        $this->UnitTexxxase('Test of Calendar_Engine_UnixTs');
    }
    function setUp() {
