<?php
// $Id: validator_unit_test.php,v 1.1 2005/12/25 21:50:40 ryu Exp $
...
class TestOfValidator extends UnitTexxxase {
    var $mockengine;
    var $mockcal;
    function TestOfValidator() {
        $this->UnitTexxxase('Test of Validator');
    }
    function setUp() {
...
class TestOfValidatorLive extends UnitTexxxase {
    function TestOfValidatorLive() {
        $this->UnitTexxxase('Test of Validator Live');
    }
    function testYear() {
