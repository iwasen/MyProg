...
/* $Id: Smarty_Compiler.class.php,v 1.2 2005/11/22 15:47:29 ryu Exp $ */
...
class Smarty_Compiler extends Smarty {
    ...
    function _compile_file($resource_name, $source_content, &$compiled_content)
    {
        ...
        // remove unxxxessary close/open tags
    ...
    function _compile_insert_tag($tag_args)
    {
        ...
        return "<?php require_once(SMARTY_CORE_DIR . 'core.run_insert_handler.php');\xxxho smarty_core_run_insert_handler($_params, \$this); ?>" . $this->_additional_newline;
    }
