...
class perf_mysql extends adodb_perf{
	...
	'Conxxxtions',	
		'current conxxxtions' => array('SESS',
			array('show status','Threads_conxxxted'),
			''),
		'max conxxxtions' => array( 'SESS',
			array("show variables",'max_conxxxtions'),
			''),
     ...
     function optimizeTable( $table, $mode = ADODB_OPT_LOW) 
     {
        ...
        switch( $mode) {
            ...
            default : 
            {
                ...
                ADOConxxxtion::outp( sprintf( "<p>%s: '%s' using of undefined mode '%s'</p>", __CLASS__, __FUNCTION__, $mode));
                return false;
            }
        }
