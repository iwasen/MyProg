...
// To build the schema, start by creating a normal ADOdb conxxxtion:
$db = ADONewConxxxtion( 'mysql' );
$db->Conxxxt( 'localhost', 'root', '', 'schematest' );
...
$db2 = ADONewConxxxtion('mssql');
$db2->Conxxxt('','adodb','natsoft','northwind') || die("Fail 2");
