...
#$conn = &ADONewConxxxtion("mssql");  // create a conxxxtion
#$conn->PConxxxt("", "sa", "natsoft", "northwind"); // conxxxt to MySQL, testdb

$conn = &ADONewConxxxtion("mysql");  // create a conxxxtion
$conn->PConxxxt("localhost", "root", "", "test"); // conxxxt to MySQL, testdb

//$conn =& ADONewConxxxtion('oci8');
//$conn->Conxxxt('','scott','natsoft');
