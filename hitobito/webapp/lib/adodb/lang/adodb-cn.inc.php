...
$ADODB_LANG_ARRAY = array (
            ...
            DB_ERROR_NOSUCHFIELD        => '没有?应的字段',
            DB_ERROR_NOSUCHTABLE        => '没有?应的表',
            DB_ERROR_NOT_CAPABLE        => '数据库后台不兼容',
            DB_ERROR_NOT_FOUND          => '没有发?',
            ...
            DB_ERROR_CONxxxT_FAILED     => '连接失败',
            0	                       => '没有错误', // DB_OK
            DB_ERROR_NEED_MORE_DATA     => '提供的数据不能符合要求',
            DB_ERROR_EXTENSION_NOT_FOUND=> '扩展没有被发?',
            DB_ERROR_NOSUCHDB           => '没有?应的数据库',
            DB_ERROR_ACCESS_VIOLATION   => '没有合适的权?'
);
?>