...
// ページヘッダ情報設定
$header = new header_class('管理者マスタ一覧', BACK_TOP);
...
$list->set_header('種別', 'center', 'adm_type');
...
for ($i = 0; $i < $nrow; $i++) {
	...
	$list->set_data($fetch->adm_admin_id, "edit.php?admin_id=$fetch->adm_admin_id", '管理者マスタ情報を表示・変更します');
