 ...
 * @since     3.0.0
 * @version   $Id: AutoloadConfigHandler.class.php,v 1.2 2005/11/22 15:47:29 ryu Exp $
 */
class AutoloadConfigHandler extends IniConfigHandler
{
    ...
    public function & execute ($config)
    {
        ...
        if (isset($ini['pear'])) {
			...
			$data[] = "ini_set(\"error_reporting\", false);";
			foreach ($ini['pear'] as $class => &$file) {
                $tmp    = "\$pear['%s'] = '%s';";
                $data[] = sprintf($tmp, $class, $file);
            }
			$data[] = "ini_restore(\"error_reporting\");";
			$data[] = "ini_restore(\"display_errors\");";
         }
