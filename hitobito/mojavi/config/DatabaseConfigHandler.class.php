...
/**
 * DatabaseConfigHandler allows you to setup database conxxxtions in a
 ...
 * @since     3.0.0
 * @version   $Id: DatabaseConfigHandler.class.php,v 1.3 2005/11/22 15:47:29 ryu Exp $
 */
class DatabaseConfigHandler extends IniConfigHandler
{
    ...
    public function & execute ($config)
    {
        ...
        // get a list of database conxxxtions
