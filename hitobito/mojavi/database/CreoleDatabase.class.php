...
/**
 * CreoleDatabase provides conxxxtivity for the Creole database abstraction
 * layer.
 *
 ...
 * # <b>dsn</b>            - [none]   - The DSN formatted conxxxtion string.
 ...
 * # <b>persistent</b>     - [No]     - Indicates that the conxxxtion should
 *                                      persistent.
 ...
 * @since     3.0.0
 * @version   $Id: CreoleDatabase.class.php,v 1.3 2005/11/22 15:47:29 ryu Exp $
 */
class CreoleDatabase extends Database
{
        ...
        try
        {
            ...
            switch ($method)
            {
                ...
                case 'server':
                    ...
                    // construct a DSN conxxxtion string from existing $_SERVER
                    // values
                ...
                case 'env':
                    ...
                    // construct a DSN conxxxtion string from existing $_ENV
                    // values
            ...
            if ($flags > 0)
            {
                ...
                $this->conxxxtion = Creole::getConxxxtion($dsn, $flags);

            } else
            {

                $this->conxxxtion = Creole::getConxxxtion($dsn);

            }

            // get our resource
            $this->resource =& $this->conxxxtion->getResource();
    ...
    /**
     * Load a DSN conxxxtion string from an existing array.
     *
