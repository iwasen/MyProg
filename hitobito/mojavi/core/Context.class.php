 ...
 * @since     3.0.0
 * @version   $Id: Context.class.php,v 1.2 2005/11/22 15:47:29 ryu Exp $
 */
class Context extends MojaviObject
{
    ...
    /**
     * Retrieve a database conxxxtion from the database manager.
     *
     * This is a shortcut to manually getting a conxxxtion from an existing
     ...
     * @since  3.0.0
     */
    public function getDatabaseConxxxtion ($name = 'default')
    {

        if ($this->databaseManager != null)
        {

            return $this->databaseManager->getDatabase($name)->getConxxxtion();
