...
If Not IsEmpty(client_id) Then
  ...
  SQL = "SELECT * FROM T_CLIENT WHERE CM_client_id='" & client_id & "' AND CM_password='" & Request.Form("pwd") & "'"
  ...
  Session("client_name") = RS("CM_client_name")
  Session("company") = RS("CM_company")
  RS.Close
  Response.Redirect Session("client_next")
End If
%>

<html>
<head>
<title>めるめる・net 広告主向けログインページ</title>
...
<table width="600" border="0" cellspacing="0" cellpadding="0" align="center">
  <tr>
    <td colspan="3">
      <table bgcolor="#ff9999" border="0" cellpadding="0" cellspacing="0" width="600" align="center">
        ...
        <tr valign="top"><!-- row 2 -->
          <td><img alt="広告主向けページ" border="0" height="52" name="head_t1" src="../images/head_t1.gif" width="348"></td>
  ...
  <tr>
    <td valign="top" bgcolor="#666666"><img height="10" src="../images/shim.gif" width="130"></td>
    <td valign="top" bgcolor="#666666"><img height="10" src="../images/shim.gif" width="461"></td>
      ...
      <form name="form1" action="login.asp" method="post">
        <table border="0" cellspacing="5" cellpadding="0" align="center">
          <tr>
            ...
            <div align="right"><font class="kihon" size="3">クライアントID（半角数字５桁）：</font></div></font></div>
            </td>
            <td>
            ...
            <td colspan="2">
              <div align="center">
                <p><span class="kihon"><font size="3" class="kihon">
                  ...
                  <input type="button" name="cancel" value="キャンセル" onClick="location.href='index.asp'">
                  </font></span></p>
              </div>
            </td>
          </tr>
  ...
  <tr>
    <td bgcolor="#666666"><img height="10" src="../images/shim.gif" width="130"></td>
    <td bgcolor="#666666"><img height="10" src="../images/shim.gif" width="461"></td>
