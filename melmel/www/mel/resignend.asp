  ...
  <TR>
    <TD valign="top" bgcolor="#FFFF00" width="130">
      <TABLE width="130" border="0" cellspacing="0" cellpadding="0">
        ...
        <TR align="center">
          <TD><A href="mlstt.asp"><IMG src="images/b_memb3.gif" width="112" height="34" alt="メルマガ情報修正" border="0"></A></TD>
        </TR>
        <TR align="center">
        ...
        <TR>
          <TD>
            <DIV align="center">
              ...
              <P><FONT size="3" class="midashi1">めるめる・netから退会しました。</FONT> <BR>
              </P>
              <P>
                <FONT size="3" class="kihon">これまでの活動ありがとうございました。 <BR>
                もし再度　めるめる・net　にご登録を希望される場合は、<BR>
                仮登録から行ってください。よろしくお願いします。</FONT></P>
              </DIV>
          </TD>
        </TR>
      </TABLE>
