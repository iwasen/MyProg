  ...
  <TR>
    <TD valign="top" bgcolor="#FFFF00" width="130">
      <TABLE width="130" border="0" cellspacing="0" cellpadding="0">
        ...
        <TR align="center">
          <TD><IMG src="images/b_memb5b.gif" width="112" height="34" alt="復会申し込み"></TD>
        </TR>
        <TR align="center">
...
If Status = 8 Then
%>
              <P><IMG src="images/t_backch.gif" width="211" height="24" alt="めるめるさん復会申し込み"><BR>
                <IMG name="chara06" src="../images/chara06.gif" width="78" height="64" border="0" alt="キャラクターイメージ">
              </P>
              <P><font size="3" class="kihon">めるめる・netに復会します。<BR>
                よろしいですか？</font></P>
              <FORM name="form1" METHOD="POST" ACTION="./backend.asp">
                <INPUT type="submit" name="Submit" value=" ＯＫ ">
              </FORM>
<%
ElseIf Status = 0 Then
%>
              <p><img src="images/t_rexxxhk.gif" width="210" height="22" alt="めるめるさん復会申し込み"><br>
                <img name="chara09" src="../images/chara07.gif" width="83" height="62" border="0" alt="キャラクターイメージ">
              </p>
              <p><font size="3" class="kihon">現在、めるめる・netを休会していません。</font></p>
<%
End If
%>
              <P>　 </P>
