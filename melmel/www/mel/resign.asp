  ...
  <TR>
    <TD valign="top" bgcolor="#FFFF00" width="130">
      <TABLE width="130" border="0" cellspacing="0" cellpadding="0">
        ...
        <TR align="center">
          <TD><IMG src="images/b_memb6b.gif" width="112" height="34" alt="退会申し込み"></TD>
        </TR>
        <tr align="center">
...
<!------------------ 本文textboxテーブル・ここから ------------------------------>
      <TABLE width="461" border="0" cellspacing="5" cellpadding="0">
        <TR>
          <TD>
            <DIV align="center">
              <P><IMG src="images/t_resign.gif" width="216" height="22" alt="めるめるさん退会申し込み"><BR>
                <IMG name="chara09" src="../images/chara09.gif" width="83" height="62" border="0" alt="キャラクターイメージ">
              </P>
              <P><FONT size="3" class="kihon">めるめる・netを退会します。<BR>
                よろしいですか？<BR>
                退会すると、めるめるさんとしての登録が破棄されます。</FONT> </P>
              <P><font size="3" class="kihon">あなたが登録されているすべてのメルマガについて<br>
              めるめる・netから情報が削除されます。</FONT> </P>
              <P><font size="3" class="kihon">再登録を希望される場合は、<BR>
              仮登録から行っていただくことになります。</font> </P>
              <FORM name="form1" METHOD="POST" ACTION="./resignend.asp">
