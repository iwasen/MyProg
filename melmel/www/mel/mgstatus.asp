...
<html>
<head>
<title>めるめる・net メルマガ活動状態の変更</title>
...
function OnClick_m_name(m_name, action) {
  return confirm(m_name + " を" + action + "に変更してよろしいですか？");
}
//-->
</script>
</head>
...
<!------------------ 本文textboxテーブル・ここから ------------------------------>
      <TABLE width="461" border="0" cellspacing="5" cellpadding="0">
        <TR>
          <TD>
            <DIV align="center">
              <P><!--<IMG src="images/t_mgstatus.gif" width="196" height="24" alt="メルマガ活動状態変更">--><b>メルマガ活動状態変更</b><BR>
                <IMG name="chara01" src="../images/chara01.gif" width="83" height="61" border="0" alt="キャラクターイメージ">
              </P>


            <FONT size="3" class="midashi1">変更するメルマガを選択してください。</FONT>
            </P>
