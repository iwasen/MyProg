...
Else
  ...
  SQL = "UPDATE T_MELMAG SET MG_status=0 WHERE MG_mel_id='" & Session("mel_id") & "' AND MG_status=8"
  DB.Execute SQL
%>
<html>
<head>
<title>めるめる・net 復会申し込み完了</title>
  ...
  <TR>
    <TD valign="top" bgcolor="#FFFF00" width="130">
      <TABLE width="130" border="0" cellspacing="0" cellpadding="0">
        ...
        <TR align="center">
          <TD><IMG src="images/b_memb5b.gif" width="112" height="34" alt="退会申し込み"></TD>
        </TR>
        <TR align="center">
...
<!------------------ 本文textboxテーブル・ここから ------------------------------>
      <TABLE width="461" border="0" cellspacing="5" cellpadding="0">
        <TR>
          <TD>
            <DIV align="center">
              <P><IMG src="images/t_backend.gif" width="245" height="24" alt="復会申し込みを受け付けました"><BR>
                <IMG src="../images/chara05.gif" width="80" height="75" alt="キャラクターイメージ">
              </P>
              <P><font size="3" class="kihon">めるめる・netに復会しました。</font></P>
              <P><FONT size="2" class="komoji"><A href="pubtop.asp">めるめるさん専用トップページへ戻る</A></FONT></P>
            </DIV>
          </TD>
        </TR>
      </TABLE>
