...
TITLE = "Inquire of ID PASS"

MSG = "ID・パスワードの問い合わせ" & vbcrlf & vbcrlf & _
"登録メールマガジン名:	" & Request.Form("mname") & vbcrlf & _
"発行社（者）名：	" & Request.Form("pname") & vbcrlf & _
"メールアドレス：	" & Request.Form("madd") & vbcrlf

Result = SendMail(OFFICE_ADDRESS, ANONYMOUS, TITLE, MSG)
Response.Write "<PRE>"

if Result <> "" then
	Response.Write ("<BR><font color=""#FF0000"">")
	Response.Write ("エラーが発生しました。office@melmel.net へ直接お問い合わせ下さい。")
...
<!--  <TR>
    <TD valign="top" colspan="3" align="left">
      <TABLE width="405" border="0" cellspacing="0" cellpadding="0">
        <TR>
          ...
          <TD><A href="../login.html"><IMG src="../images/tab_hakko1b.gif" width="130" height="25" alt="発行者向けトップページ" border="0"></A></TD>
  ...
  <TR>
    <TD valign="top" bgcolor="#FFFFFF" colspan="2"> <!------------------ 本文textboxテーブル・ここから ------------------------------>
      <TABLE width="591" border="0" cellspacing="5" cellpadding="0">
        <TR>
          <TD>
<!--            <P align="center"><IMG src="images/t_idcheck.gif" width="132" height="23"></p><BR> -->
              <P align="center"><IMG src="../images/chara05.gif" width="80" height="75"></p><BR>
            <P align="center"><FONT size="3" class="kihon">ID・パスワードの問い合わせを受け付けました。<BR><BR><BR>
              <FONT size="3" class="kihon">追って登録メールアドレスに登録情報をお送りします。</FONT> </P>
            <P align="center">　 </P>
            </TD>
        </TR>
      </TABLE>
