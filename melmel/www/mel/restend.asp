...
Else
  ...
  SQL = "UPDATE T_MELMAG SET MG_status=8 WHERE MG_mel_id='" & Session("mel_id") & "' AND MG_status=0"
  DB.Execute SQL
%>
<html>
<head>
<title>めるめる・net 休会申し込み完了</title>
  ...
  <TR>
    <TD valign="top" bgcolor="#FFFF00" width="130">
      <TABLE width="130" border="0" cellspacing="0" cellpadding="0">
        ...
        <TR align="center">
          <TD><A href="mlist.asp"><IMG src="images/b_memb3.gif" width="112" height="34" alt="メルマガ情報修正" border="0"></A></TD>
        </TR>
        <TR align="center">
...
<!------------------ 本文textboxテーブル・ここから ------------------------------>
      <TABLE width="461" border="0" cellspacing="5" cellpadding="0">
        <TR>
          <TD>
            <DIV align="center">
              <P><IMG src="images/t_restend.gif" width="252" height="22" alt="休会申し込みを受け付けました。"><BR>
                <IMG name="chara07" src="../images/chara07.gif" width="81" height="55" border="0" alt="キャラクターイメージ">
              </P>
              <P class="kihon">めるめる・netを休会しました。</P>
