...
SetHeaderTitle "広告情報入力", TC_KOUKOKU
...
function OnClick_sakujo() {
  if (confirm("この広告を削除してよろしいですか？")) {
    location.href = "nyuukou5.asp?id=" + document.form1.koukoku_id.value;
  }
}
//-->
</SCRIPT>
...
<%
Dim koukoku_id, koukoku_name, client_name, company, koukoku_shuu, pub_start, pub_end, busuu, keisai_irai, koukoku_msg, limit_date, koukoku_type, jogai_id, koukoku_url, client_id
...
Writeln "<option value=''" & Selected(client_id, "") & ">選択してください</option>"
Do Until RS.EOF
...
%>
          ...
          <tr>
            ...
            <td class="n2"><input type="text" name="jogai_id" size="40" maxlength=50 value="<%=jogai_id%>">&nbsp;&nbsp;<font size="-1">（除外したい過去の広告IDをカンマで区切って入力してください）</font></td>
          </tr>
        </table>
      </td>
    </tr>
