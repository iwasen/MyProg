...
SetHeaderTitle "予約登録", TC_KOUKOKU
...
%>
          ...
          <tr>
            <td class="m2" width="20%">広告依頼主名<font size="-1">（必須）</font></td>
...
%>
          ...
          <tr>
            <td class="m2">発行部数<font size="-1">（必須）</font></td>
