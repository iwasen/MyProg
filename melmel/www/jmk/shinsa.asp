...
SetHeaderTitle "‰¼“o˜^R¸Œ‹‰Ê", TC_HAKKOUSHA
...
function OnClick_OK(id) {
  if (confirm("w’è‚µ‚½ƒƒ‹ƒ}ƒK[ID=" + id + "]‚ğR¸‚n‚j‚É‚µ‚Ü‚·‚©H")) {
    location.href = "shinsa2.asp?id=" + id + "&ok=1";
  }
}
function OnClick_NG(id) {
  if (confirm("w’è‚µ‚½ƒƒ‹ƒ}ƒK[ID=" + id + "]‚ğR¸‚m‚f‚É‚µ‚Ü‚·‚©H")) {
    if (confirm("–{“o˜^‚¨’f‚èƒ[ƒ‹‚ğ‘—M‚µ‚Ü‚·‚©H"))
...
<table width="100%">
  <tr>
    <td align="left">¡‰¼“o˜^ŒãA‚Ü‚¾R¸Œ‹‰Ê‚ªo‚Ä‚¢‚È‚¢ƒƒ‹ƒ}ƒK‚Ìˆê—— <font size="-1">iID‚ğƒNƒŠƒbƒN‚·‚é‚Æ‰¼“o˜^î•ñ‚ğ•\¦‚µ‚Ü‚·j</font></td>
...
Do Until RS.EOF
  ...
  Else
    Writeln "<td align='center'><nobr>R¸Ï‚İ</nobr></td>"
  End If
