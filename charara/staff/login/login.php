...
set_global('charara', '', 'きゃららFactory 作画スタッフログイン', BACK_NONE);
?>
<html lang="ja">
<head>
	    ...
	    <td>
	      <table border=0 cellspacing=2 cellpadding=3 width="100%">
	        <tr>
	          ...
	          <td class="n1"><input class="alpha" type="text" name="login_id" size=40 <?=value($_COOKIE['staff_mail_addr'])?>></td>
	        </tr>
	        <tr>
	          <td class="m1" width="25%">パスワード</td>
	          <td class="n1"><input type="password" name="password" size=40 maxlength=20></td>
	        </tr>
	      </table>
	    </td>
	  </tr>
