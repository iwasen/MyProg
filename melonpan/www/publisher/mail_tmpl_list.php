...
function make_maglist($publisher_id,$owner_pswd) {
	...
	$sql = "SELECT * FROM M_MAGAZINE WHERE (mag_pub_status_flg = '01' or mag_pub_status_flg = '03') and publisher_id = $publisher_id";
	$result = db_exec($sql);
	...
	for ($i = 0; $i < $nrow; $i++) {
		...
		print "<form name=$fom_name action=\"mail_tmpl_down.php\" method=\"post\">\n";
		print "<tr>\n";
		print "<td width=\"67\" align=\"center\">$mag_id</td>\n";
		print "<td width=\"337\">".htmlspecialchars($mag_nm)."</td>\n";
		print "<td width=\"82\"> \n";
		print "<input type=\"submit\" value=\"テンプレート発行\">\n";
		print "</td>\n";
		print "</tr>\n";
