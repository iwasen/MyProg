...
//	if (confirm("発行者登録を削除します。よろしいですか？")) {
...
<form method="post" action="hakkousha_mainte3.php" name="form1" onSubmit="return OnSubmit_form1();">
	...
	<table border=0 cellspacing=1 cellpadding=3 width="700">
		...
		<tr>
			<td class="m5">りばっチャ</td>
			<td class="n5">
				<input type="radio" name="owner_riba_flg" value="1" <?= $riba ?>> あり
				<input type="radio" name="owner_riba_flg" value="" <?= $no_riba ?>> なし
			</td>
		</tr>
		<tr>
			<td class="m5">ポイント</td>
			<td class="n5"><?= number_format($pt_melonpan) ?> ポイント</td>
		</tr>
		<tr>
			<td class="m5">登録日</td>
<? if ($reg_year == "") { ?>
