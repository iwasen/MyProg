...
function OnClick_sakujo() {
    ...
    location.href = "letter_bakyun5.php?index_id=<?= $index_id ?>&mag_id=<?= $mag_id ?>";
	}
}
//-->
</SCRIPT>
...
<center>
<form method="post" style="margin:0" action="letter_bakyun4.php" name="form1" onSubmit="return OnSubmit_form1();">
...
?>
      ...
      <td class="n6">
				...
				<select name="reserve_hour"><? select_hour('', $reserve_hour); ?></select>時
				<select name="reserve_minutes"><? select_minute('', $reserve_minutes); ?></select>分
			</td>
    </tr>
  </table>
