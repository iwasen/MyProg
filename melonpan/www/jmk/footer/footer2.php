...
<form method="post" action="footer4.php" name="form1" onSubmit="return OnSubmit_form1();">
	...
	<table border=0 cellspacing=2 cellpadding=3 width="80%">
		...
		<tr>
			...
			<td class="n6">
				<select name="insert_year"><? select_year(date("Y"), '', $insert_year); ?></select>年
				<select name="insert_month"><? select_month('', $insert_month); ?></select>月
				<select name="insert_day"><? select_day('', $insert_day); ?></select>日
				〜
				<select name="insert_year_end"><? select_year(date("Y"), '', $insert_year_end); ?></select>年
				<select name="insert_month_end"><? select_month('', $insert_month_end); ?></select>月
				<select name="insert_day_end"><? select_day('', $insert_day_end); ?></select>日
			</td>
		</tr>
	</table>
	<br>
