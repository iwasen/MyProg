...
/* **
	$mag_body2 = trim($mag_body);
	for ($i = 0;$i < mbstrlen($mag_body2); $i = $i + 38) {
		$mag_body .= "　　" . mbsubstr($mag_body2 . " ", $i, 38) . "\n";
	}
*/
?>
    ...
    <td align="center"> 
      <table width="620" border="0" cellspacing="0" cellpadding="0" align="center">
        ...
        <tr> 
          ...
          <td width="557" bgcolor="#90c84b"><!-- #BeginEditable "title2" --><img src="img/syosai.gif" width="89" height="21"><!-- #EndEditable --></td>
