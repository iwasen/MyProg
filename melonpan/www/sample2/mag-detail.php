...
// Get URL
//
	$copy_mag_id = $resarray[0]."：".trim($resarray[1])."\n";
	$copy_url = "http://www.melonpan.net/mag.php?$resarray[0]";
//
...
// Get Recommend
//
if ($last_recomend_id == "") { $last_recomend_id = 99999999;} //2002.1.11 9999999999999999→99999999変更
