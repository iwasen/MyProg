...
?>
	<tr class="tc<?=$i % 2?>">
		...
		<td><a href="edit.php?wm_no=<?=$fetch->wm_seq_no?>" title="Welcomeメッセージ情報を表示・変更します"><?=htmlspecialchars($fetch->wm_text)?></a></td>
