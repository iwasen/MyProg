...
<table border=0 cellspacing=2 cellpadding=3 width="80%">
	...
	<tr>
		...
		<td class="n1" width="80%">
			<font size=-1>
			<input type="radio" name="target" value=3 checked>本登録会員のみ
			<input type="radio" name="target" value=2>仮登録２会員のみ
			<input type="radio" name="target" value=1>仮登録１会員のみ
<!--			<input type="radio" name="target" value=4>全会員-->
			</font>
		</td>
	</tr>
	<tr>
