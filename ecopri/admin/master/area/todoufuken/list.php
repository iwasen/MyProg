...
?>
	<tr class="tc<?=$i % 2?>">
		<td align="center"><a href="edit.php?ar_cd=<?=$fetch->ar_area_cd?>" title="都道府県情報を表示・変更します"><?=$fetch->ar_area_cd?></a></td>
