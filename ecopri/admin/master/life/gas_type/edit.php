...
if (pg_numrows($result) == 0)
	system_error("ガスタイプIDが不正", __FILE__);
...
function update_check(f) {
	...
	return confirm("ガスタイプマスタ情報を更新します。よろしいですか？");
}
function delete_check(f) {
	return confirm("ガスタイプ名を削除します。よろしいですか？");
}
//-->
</script>
</head>
...
<table border=0 cellspacing=2 cellpadding=3 width="100%">
	<tr>
		<td class="m0" colspan=2>■ガスタイプ情報を入力してください。</td>
	</tr>
	<tr>
