...
<div align="center">
<form name="form1" method="post" action="member_change04_check.php">
<table width="714" height ="90%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
	...
	<tr>
		...
		<td align="center" valign="top">
			<table border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td bgcolor="#FFCC66"><img src="img/spacer.gif" width="620" height="4"></td>
				</tr>
			</table>
			<table border="0">
				<tr>
...
-->
			...
			<img src="img/nyuukai/page/04.gif" alt="４ページ目">
		</td>
...
if (!$reg->back_page) {
?>
					<td><a href="member_change03.php"><img src="img/nyuukai/button/back.gif" border="0" alt="戻る" width="99" height="40"></a></td>
					<td width="10"></td>
