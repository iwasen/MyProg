...
<!-- 1段目 -->
				<tr>
					...
					<td bgcolor="#FFFFFF" class="tc0">洗濯には、風呂の残り湯利用をお薦めします。洗いとすすぎの1回目に風呂水を利用すると･･･</td>
					<td bgcolor="#FFFFFF"><img src="img/one/meter/25.gif" border="0" width="100" height="45"></td>
<!--					<td bgcolor="#FFFFFF" align="middle"><a href="sim_sentaku.php" title="シミュレーション"><img src="img/one/one_foot01.gif" border="0"></a></td>-->
					<td bgcolor="#FFFFFF" align="middle"><a href="kaji_sentaku_furomizu.php" title="診断＆ガンバリスト登録"><img src="img/one/one_foot01.gif" border="0"></a></td>
					<td bgcolor="#FFFFFF" align="middle"><? disp_master_mark(GANBA_SENTAKU) ?></td>
				</tr>
				<tr>
					<td bgcolor="#FFFFFF" class="tc0">洗濯のすすぎは、注水ではなく溜めすすぎにしましょう。注水すすぎをやめて、溜めすすぎにすると･･･</td>
					<td bgcolor="#FFFFFF"><img src="img/one/meter/13.gif" border="0" width="100" height="45"></td>
					<td bgcolor="#FFFFFF" align="middle"><a href="kaji_sentaku_chusui.php" title="診断＆ガンバリスト登録"><img src="img/one/one_foot03.gif" border="0"></a></td>
...
<!--
				<tr>
					<td bgcolor="#FFFFFF" class="tc0">給湯器も、効率のよいものがでています。ガス給湯機を高効率タイプに替えると･･･</td>
