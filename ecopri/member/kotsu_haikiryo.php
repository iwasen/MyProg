...
<form method="post" name="form1" action="kesshin.php">
	<input type="hidden" name="ganbalist_id" <?=value(GANBA_HAIKIRYOU)?>>
	<input type="hidden" name="energy" <?=value(3111)?>>
	<input type="hidden" name="cost" <?=value(36520)?>>
	<input type="hidden" name="co2" <?=value(874)?>>
</form>
...
<table border="0" cellpadding="0" cellspacing="0" width="714" height="90%" bgcolor="#FFFFFF">
	<tr>
		...
		<td align="center" valign="top">
			<!-- タイトル部分 -->
			<br>
			<img src="img/shindan/title/haiki_01.gif"><br>
			<!-- タイトル部分終了 -->

			<!-- ここに入力 -->
			<font color="red">自動車の排気量によって、エネルギー消費量が異なります。</font><br><br>

			自動車の排気量の違いによるエネルギー消費量の比較
			<table border="1">
				<tr>
				...
				<tr>
					...
					<td style="padding:4" class="tc1">ガソリン車、排気量2000cc。</td>
				...
				<tr>
					...
					<td style="padding:4" class="tc1">ガソリン車、排気量1500cc。</td>
			...
			<table border="0" cellpadding="0" cellspacing="2">
				...
				<tr>
					<td></td>
					<td class="tc0">一年に1万km走行。アイドリングなしで計算。</td>
				</tr>
			...
			<table border=0 cellspacing=2 cellpadding=0>
				...
				<tr>
					<td align="center">
						<table border="1" bordercolor="#cccccc" cellpadding="0" cellspacing="2" width="550">
							...
							<tr>
								<td align="center" bgcolor="#ffe397" width="260">1,556</td>
								<td align="center" bgcolor="#ffffc2" width="95">18,260</td>
								<td align="center" bgcolor="#deffff" width="195">437</td>
							</tr>
						</table><br>
					</td>
				</tr>
				...
				<tr>
					<td align="center"><b>【今度買うなら排気量は少なめに！】</b><br><br></b></td>
				</tr>
			</table>
