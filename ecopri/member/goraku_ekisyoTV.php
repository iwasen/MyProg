...
<table border="0" cellpadding="0" cellspacing="0" width="714" height="90%" bgcolor="#FFFFFF">
	<tr>
		...
		<td align="center" valign="top">
			...
			<!-- ここに入力 -->
			<font color="red">テレビの種類によって、エネルギー消費量が異なります。</font><br><br>

			テレビの種類の違いによる電気のエネルギー消費量の比較
			<table border="1">
				<tr>
				...
				<tr>
					...
					<td style="padding:4" class="tc1">リビングでは、ブラウン管テレビ（28型ワイド）</td>
				...
				<tr>
					...
					<td style="padding:4" class="tc1">リビングでは、液晶テレビ（28型）</td>
					<td align="center" valign="middle" width="100">152Mcal</td>
					<td align="center" valign="middle" width="120">
						<img src="img/shindan/energy/denki.gif" align="middle" width="44" height="44" border="0"> 4,350円
					</td>
			...
			<table border="0">
				<tr>
					<td class="tc0">試算条件：</font></td>
					<td class="tc0">夫婦と子ども二人家族対象。テレビは、視聴時間以外の待機電力も含む。</td>
				</tr>

				<tr>
					<td></td>
					<td class="tc0">ながら視聴なし、主寝室のテレビは21型ブラウン管テレビ。</td>
				</tr>
			...
			<table border=0 cellspacing=2 cellpadding=0>
				...
				<tr>
					<td align="center"><b>【今度買うならブラウン管TVより液晶TV！】</b><br><br></b></td>
				</tr>
			</table>
