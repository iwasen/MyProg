			...
			<!-- ここに入力 -->
				...
				<table border="0" cellspacing="0" cellpadding="0" width="720" bgcolor="#ff0000">
					<tr>
						...
						<td width="128"><a href="all_graph02.php"><img src="img/graph/graph02.gif" border="0"></a></td>
						<td width="128"><a href="all_graph03.php"><img src="img/graph/graph03.gif" border="0"></a></td>
						<td><img src="img/spacer.gif" height=10 width=10></td>
					</tr>
					<tr>
						<td colspan="4" height="10" bgcolor="#FFFF00"><img src="img/spacer.gif" height=10 width=10></td>
					</tr>
				</table>
						...
						<td colspan="3" align="center" valign="center" bgcolor="ffffff">
							...
							<OBJECT ID=SWFlash classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"
							 ...
							 WIDTH="600" HEIGHT="550">
								<PARAM NAME=movie VALUE="flash/result_noaction.swf">
								<PARAM NAME=quality VALUE=high>
								<PARAM NAME=bgcolor VALUE=#FFFFFF>
								<PARAM NAME=play VALUE=TRUE>
								<PARAM NAME=loop VALUE=FALSE>
								<PARAM NAME=FlashVars VALUE="<?=$fv?>">
								<EMBED src="flash/result_noaction.swf" play=TRUE loop=FALSE quality=high bgcolor=#FFFFFF  WIDTH="700" HEIGHT="550" NAME="SWFlash"
