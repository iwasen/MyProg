...
<table border="0" cellpadding="0" cellspacing="0" width="714" height="90%" bgcolor="#FFFFFF">
	<tr>
		...
		<td align="center" valign="top">
			...
			<!-- タイトル部分 -->
			<br>
			<img src="img/shindan/title/gomi_02.gif"><br>
			<!-- タイトル部分終了 -->

			<!-- ここに入力 -->
			<font color="red">ごみの出しの方によって、二酸化炭素排出量が異なります。</font><br><br>

			ごみのリサイクルによる二酸化炭素排出量の比較
			<table border="1">
				<tr>
				...
				<tr>
					...
					<td style="padding:4" class="tc1">牛乳パックは全て「燃えるごみ」として処理され、かわりに新たに作られる。</td>
					<td align="center" valign="middle" width="100">−</td>
					<td align="center" valign="middle" width="120">−</td>
					<td align="center" valign="middle" width="135">49 kg・CO<sub>2</sub></td>
				</tr>

				<tr>
					<td align="center" valign="middle"><img src="img/shindan/seika/suisyou.gif" width="65" height="67" border="0"></td>
					<td style="padding:4" class="tc1">牛乳パックは全てリサイクル利用される。</td>
					<td align="center" valign="middle" width="100">−</td>
					<td align="center" valign="middle" width="120">−</td>
					<td align="center" valign="middle" width="135">4 kg・CO<sub>2</sub></td>
				</tr>
			</table>
			...
			<table border="0">
				...
				<tr>
					<td></td>
					<td class="tc0">牛乳パックは、可燃ごみ排出量2kg/日に対して1.2%相当排出。</td>
				</tr>
			...
			<table>
				<tr>
					...
					<td><a href="sim_shigengomi.php" title="シミュレーション"><img src="img/shindan/sim_syosai/button_ecoshindan.gif" border="0" width="145" height="36"></a></td>
				</tr>
			</table>
			<!-- ここまで -->
		</td>
