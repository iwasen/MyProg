...
<form method="post" name="form1" action="kesshin.php">
	<input type="hidden" name="ganbalist_id" <?=value(GANBA_SUSUGI)?>>
	<input type="hidden" name="water" <?=value(21)?>>
	<input type="hidden" name="cost" <?=value(2510)?>>
	<input type="hidden" name="co2" <?=value(13)?>>
</form>
...
<table border="0" cellpadding="0" cellspacing="0" width="714" height="90%" bgcolor="#FFFFFF">
	<tr>
		...
		<td align="center" valign="top">
			<!-- タイトル部分 -->
			<br>
			<img src="img/shindan/title/sentaku_02.gif"><br>
			<!-- タイトル部分終了 -->

			<!-- ここに入力 -->
			<font color="red">洗濯のすすぎ方法によって、水道使用量が異なります。</font><br><br>

			洗濯のすすぎ方法の違いによる水使用量の比較
			<table border="1">
				<tr>
				...
				<tr>
					...
					<td style="padding:4" class="tc1">溜めすすぎをする</td>
				...
				<tr>
					<td align="center" valign="middle">
						<img src="img/shindan/seika/sankou.gif" width="65" height="67" border="0">
					</td>
					<td style="padding:4" class="tc1">注水すすぎをする</td>
					<td align="center" valign="middle" width="100">86m3</td>
					<td align="center" valign="middle" width="120">
						<img src="img/shindan/energy/suidou.gif" align="middle" width="44" height="44" border="0">10,040円
					</td>
					<td align="center" valign="middle" width="135">50 kg・CO<sub>2</sub></td>
				</tr>
			</table>
			...
			<table border="0">
				...
				<tr>
					<td></td>
					<td class="tc0">洗濯機容量は7ｋｇ、一日一回。風呂水は利用しない。</td>
				</tr>
			...
			<table border=0 cellspacing=2 cellpadding=0>
				...
				<tr>
					<td align="center">
						<table border="1" bordercolor="#cccccc" cellpadding="0" cellspacing="2" width="550">
							...
							<tr>
								<td align="center" bgcolor="#ffe397" width="260">21</td>
								<td align="center" bgcolor="#ffffc2" width="95">2,510</td>
								<td align="center" bgcolor="#deffff" width="195">13</td>
							</tr>
						</table><br>
					</td>
				</tr>
				...
				<tr>
					<td align="center"><b>【注水すすぎをやめためすすぎにしよう】</b><br><br></b></td>
				</tr>
			</table>
