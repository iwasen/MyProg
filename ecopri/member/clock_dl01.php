		...
		<td align="center" valign="bottom">
			<table border="0" cellspacing="0" cellpadding="0">
				<tr align="center" valign="middle">
					...
					<td><a href="clock_dl02.php"><img src="img/nyuukai/zoumama/iru.gif" border="0" alt="ダウンロードする" width="122" height="22"></a></td>

					<td width="10"><img src="img/spacer.gif" width="10" height="34"></td>

					<!-- 変更点 -->
					<td><a href="main.php"><img src="img/nyuukai/zoumama/iranai.gif" width="122" height="22" alt="ダウンロードしない" border="0"></a></td>
				</tr>
