...
<table border="0" cellpadding="0" cellspacing="0" width="714" height="90%" bgcolor="#FFFFFF">
	<tr>
		...
		<td align="center" valign="top">
			...
			<!-- タイトル部分 -->
			<br>
			<img src="img/shindan/title/reibou_01.gif"><br>
			<!-- タイトル部分終了 -->

			<!-- ここに入力 -->
			<font color="red">就寝時、冷房の使用方法によって、エネルギー消費量が異なります。</font><br><br>
			...
			<table border="1">
				...
				<tr>
					...
					<td style="padding:4" class="tc1">就寝後、主寝室、個室2室は設定温度27℃でエアコン使用。</td>
					<td align="center" valign="middle" width="100">424Mcal</td>
					<td align="center" valign="middle" width="120">
						<img src="img/shindan/energy/denki.gif" align="center" width="44" height="44" border="0">12,120 円
					</td>
					<td align="center" valign="middle" width="135">215 kg・CO<sub>2</sub></td>
				</tr>

				<tr>
					<td align="center" valign="middle"><img src="img/shindan/seika/suisyou.gif" width="65" height="67" border="0"></td>
					<td style="padding:4" class="tc1">就寝後、主寝室、個室2室は設定温度29℃でエアコン使用。</td>
					<td align="center" valign="middle" width="100">240Mcal</td>
					<td align="center" valign="middle" width="120">
						<img src="img/shindan/energy/denki.gif" align="center" width="44" height="44" border="0"> 6,870 円
					</td>
					<td align="center" valign="middle" width="135">122 kg・CO<sub>2</sub></td>
				</tr>
			</table>
			...
			<table border="0">
				...
				<tr>
					<td></td>
					<td class="tc0">主寝室、個室2室はエアコンのみ。夜22時より明朝7時まで運転。</td>
				</tr>
			...
			<table>
				<tr>
					...
					<td><a href="sim_reibou_ko.php" title="シミュレーション"><img src="img/shindan/sim_syosai/button_ecoshindan.gif" border="0" width="145" height="36"></a></td>
				</tr>
			</table>
			<!-- ここまで -->
		</td>
