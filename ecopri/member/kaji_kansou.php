...
<table border="0" cellpadding="0" cellspacing="0" width="714" height="90%" bgcolor="#FFFFFF">
	<tr>
		...
		<td align="center" valign="top">
			...
			<!-- タイトル部分 -->
			<br>
			<img src="img/shindan/title/kansou.gif"><br>
			<!-- タイトル部分終了 -->

			<!-- ここに入力 -->
			<font color="red">乾燥(洗濯)の方法によって、エネルギー消費量が異なります。</font><br><br>

			乾燥の方法の違いによる電気のエネルギー消費量の比較
			<table border="1">
				<tr>
				...
				<tr>
					...
					<td style="padding:4" class="tc1">晴天時には、天日干し。<br>雨天時には全乾燥。<br>(梅雨・雨天日は90日)</td>
					<td align="center" valign="middle" width="100">189Mcal</td>
					<td align="center" valign="middle" width="120">
						<img src="img/shindan/energy/denki.gif" align="middle" width="44" height="44" border="0"> 5,420円
					</td>
					<td align="center" valign="middle" width="135">74 kg・CO<sub>2</sub></td>
				</tr>
				...
				<tr>
					...
					<td style="padding:4" class="tc1">晴天時には、天日干し。<br>雨天時には室内干しをした後に、仕上げ乾燥。<br>(雨天日は60日)</td>
					<td align="center" valign="middle" width="100">63Mcal</td>
					<td align="center" valign="middle" width="120">
						<img src="img/shindan/energy/denki.gif" align="middle" width="44" height="44" border="0"> 1,810円
					</td>
					<td align="center" valign="middle" width="135">25 kg・CO<sub>2</sub></td>
				</tr>
			</table>
			...
			<table border="0">
				<tr>
					...
					<td class="tc0">夫婦と子ども二人家族対象。洗濯物乾燥量4kg/日。</td>
				</tr>
			...
			<table>
				<tr>
					...
					<td><a href="sim_kansou.php" title="シミュレーション"><img src="img/shindan/sim_syosai/button_ecoshindan.gif" border="0" width="145" height="36"></a></td>
				</tr>
			</table>
			<!-- ここまで -->
		</td>
