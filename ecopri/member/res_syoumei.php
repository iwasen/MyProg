...
// フォームからデータ取得
$sim->lighting_ary = $lighting_ary;
$sim->hour_ary = $hour_ary;
$sim->lighting_ary_e = $lighting_ary_e;
$sim->hour_ary_e = $hour_ary_e;
	...
	<tr>
		...
		<td align="center" valign="top">
			...
			<table border="0" cellpadding="0" cellspacing="2">
				<tr>
					<td>
						<img src="img/shindan/title/kekka_syoumei.gif" border="0" width="306" height="57">
					</td>
				</tr>
			</table>
			...
			<!-- ここに入力 -->
			<font size=4 color="#4842ff"><b>あなたの家の照明点灯方法を変えると、次のような効果があります！</b></font>
			<br><br>
			...
			<form name="form1" action="kesshin.php" method="post">
				<table border="0" width=650>
					<tr>
						<td align="center">
							<img src="img/shindan/conte/036.gif" border="0" width="300" height="200">
						</td>
					</tr>
					<tr>
...
?>
							<?=$msg?><br><br>
							<input type="hidden" name="ganbalist_id" <?=value(GANBA_SHOUMEI)?>>
