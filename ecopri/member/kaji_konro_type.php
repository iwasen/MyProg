...
<form method="post" name="form1" action="kesshin.php">
	<input type="hidden" name="ganbalist_id" <?=value(GANBA_KONRO)?>>
	<input type="hidden" name="energy" <?=value(100)?>>
	<input type="hidden" name="cost" <?=value(1360)?>>
	<input type="hidden" name="co2" <?=value(21)?>>
</form>
...
<table border="0" cellpadding="0" cellspacing="0" width="714" height="90%" bgcolor="#FFFFFF">
	<tr>
		...
		<td align="center" valign="top">
			<!-- タイトル部分 -->
			<br>
			<img src="img/shindan/title/konro_01.gif"><br>
			<!-- タイトル部分終了 -->

			<!-- ここに入力 -->
			<font color="red">コンロの種類によって、同じ調理方法でもエネルギー消費量が異なります。</font><br><br>

			調理に使用するコンロのエネルギー消費量の比較
			<table border="1">
				<tr>
					<td align="center" valign="middle">熱源<br>種類</td>
				...
				<tr height="40">
					...
					<td height="40" style="padding:4" class="tc1">グリルつき<br>普及版3口ガスコンロ</td>
					<td align="center" valign="middle" width="100" height="40">430Mcal</td>
					<td align="center" valign="middle" width="120" height="40">
						<img src="img/shindan/energy/gas.gif" align="middle" width="44" height="44" border="0"> 5,810円
					</td>
					<td align="center" valign="middle" width="135" height="40">92 kg・CO<sub>2</sub></td>
				</tr>
				...
				<tr height="40">
					...
					<td height="40" style="padding:4" class="tc1">グリルつき<br>3口コンロ高効率ガスコンロ</td>
					<td align="center" valign="middle" width="100" height="40">330Mcal</td>
					<td align="center" valign="middle" width="120" height="40">
						<img src="img/shindan/energy/gas.gif" align="middle" width="44" height="44" border="0"> 4,450円
					</td>
					<td align="center" valign="middle" width="135" height="40">71 kg・CO<sub>2</sub></td>
				</tr>
				...
				<tr height="40">
					...
					<td height="40" style="padding:4" class="tc1">IHヒーター</td>
					<td align="center" valign="middle" width="100" height="40">220Mcal</td>
					<td align="center" valign="middle" width="120" height="40">
						<img src="img/shindan/energy/denki.gif" align="middle" width="44" height="44" border="0"> 6,290円
					</td>
					<td align="center" valign="middle" width="135" height="40">111 kg・CO<sub>2</sub></td>
				</tr>
			</table>
			...
			<table border=0 cellspacing=2 cellpadding=0>
				...
				<tr>
					<td align="center">
						<table border="1" bordercolor="#cccccc" cellpadding="0" cellspacing="2" width="550">
							...
							<tr>
								<td align="center" bgcolor="#ffe397" width="260">100</td>
								<td align="center" bgcolor="#ffffc2" width="95">1,360</td>
								<td align="center" bgcolor="#deffff" width="195">21</td>
							</tr>
						</table><br>
					</td>
				</tr>
				...
				<tr>
					<td align="center"><b>【今度使うなら普及型コンロより高効率ガスコンロ！】</b><br><br></b></td>
				</tr>
			</table>
