	...
	<tr>
		...
		<td align="center" valign="top">
			...
			<table border="0" cellpadding="0" cellspacing="2">
				<tr>
					<td>
						<img src="img/shindan/title/kekka_nyuyoku_02.gif" border="0" width="403" height="57">
					</td>
				</tr>
			</table>
			...
			<!-- ここに入力 -->
			<font size=4 color="#4842ff"><b>あなたの家の入浴時のシャワー・蛇口利用方法を変えると、次のような効果があります！</b></font>
			<br><br>
			...
			<form name="form1" action="kesshin.php" method="post">
				<table border="0" width=650>
					<tr>
						<td align="center">
							<img src="img/shindan/conte/045.gif" border="0" width="300" height="200">
						</td>
					</tr>
					<tr>
...
?>
							<?=$msg?><br><br>
							<input type="hidden" name="ganbalist_id" <?=value(GANBA_SHOWER)?>>
...
<?
	...
	echo SIM_ALERT;
?>
							<a href="javascript:history.back()"><img src="img/shindan/button/saishindan.gif" border="0" width="117" height="36"></a>
							<hr width="95%" size="1">
						</td>
					</tr>
				</table>
