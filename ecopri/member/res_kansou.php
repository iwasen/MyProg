...
// フォームからデータ取得
$sim->dryer_type = $dryer_type;
$sim->capacity = $capacity;
$sim->times = $times;
$sim->method_fair = $method_fair;
$sim->method_rain = $method_rain;
$sim->dryer_type_e = $dryer_type_e;
$sim->method_fair_e = $method_fair_e;
$sim->method_rain_e = $method_rain_e;
	...
	<tr>
		...
		<td align="center" valign="top">
			...
			<table border="0" cellpadding="0" cellspacing="2">
				<tr>
					<td>
						<img src="img/shindan/title/kekka_kansou.gif" border="0" width="381" height="58">
					</td>
				</tr>
			</table>
			...
			<!-- ここに入力 -->
			<font size=4 color="#4842ff"><b>あなたの家の乾燥（洗濯）方法を変えると、次のような効果があります！</b></font>
			<br><br>
			...
			<form name="form1" action="kesshin.php" method="post">
				<table border="0" width=650>
					<tr>
						<td align="center">
							<img src="img/shindan/conte/063.gif" border="0" width="300" height="200">
						</td>
					</tr>
					<tr>
						<td align="center" valign="top">
...
?>
							<?=$msg?><br><br>
							<input type="hidden" name="ganbalist_id" <?=value(GANBA_KANSOU)?>>
