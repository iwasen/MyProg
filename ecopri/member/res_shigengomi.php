...
<table border="0" cellpadding="0" cellspacing="0" width="714" bgcolor="#FFFFFF">
	<tr>
		...
		<td align="center" valign="top">
			...
			<!-- ここに入力 -->
			<font size=4 color="#4842ff"><b>あなたの家の資源ごみの出し方を変えると、次のような効果があります！</b></font>
			<br><br>
			...
			<!-- ここまで -->
			<font size="2">注）二酸化炭素排出量は、資源ごみが廃棄されて新しい原料から製造された場合と、<br>
			リサイクルされて再利用された場合との差を表しています。<br>
			<br>
