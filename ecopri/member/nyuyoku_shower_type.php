...
<title>シャワーヘッドの種類による違い（詳細）</title>
...
<table border="0" cellpadding="0" cellspacing="0" width="714" height="90%" bgcolor="#FFFFFF">
	<tr>
		...
		<td align="center" valign="top">
			...
			<!-- ここに入力 -->
			<font color="red"> シャワーヘッドの種類によって、同じ使用時間でも、エネルギー消費量が異なります。</font><br><br>

			シャワーヘッドの種類によるエネルギー消費量の比較
			<table border="1">
				<tr>
					<td align="center" valign="middle">給湯<br>熱源</td>
				...
				<tr>
					...
					<td style="padding:4" class="tc1">普及型シャワーヘッド</td>
					<td align="center" valign="middle" width="100">2,968Mcal</td>
					<td align="center" valign="middle" width="120">
						<img src="img/shindan/energy/gas.gif" align="middle" width="44" height="44" border="0">40,070円
						<img src="img/shindan/energy/suidou.gif" align="middle" width="44" height="44" border="0">10,210円
					</td>
				...
				<tr>
					...
					<td style="padding:4" class="tc1">手元クリック型シャワーヘッド<br>1人1分使用時間を減らす。</td>
					<td align="center" valign="middle" width="100">2,473Mcal</td>
					<td align="center" valign="middle" width="120">
						<img src="img/shindan/energy/gas.gif" align="middle" width="44" height="44" border="0">33,390円
						<img src="img/shindan/energy/suidou.gif" align="middle" width="44" height="44" border="0"> 8,510円
					</td>
			...
			<table border="0">
				<tr>
					...
					<td class="tc0">夫婦と子ども二人家族対象。毎日入浴。標準シャワー使用時間24分/日。</td>
				</tr>
				...
				<tr height="20">
					<td height="20"></td>
					<td height="20" class="tc0">料金は、都市ガス13.5円/Mcal、水道116.6円/m3で計算。</td>
				</tr>
			...
			<table border=0 cellspacing=2 cellpadding=0>
				...
				<tr>
					<td align="center"><b>【シャワーヘッドを普及型から手元クリック型にかえよう！】</b><br><br></b></td>
				</tr>
			</table>
