...
// フォームからデータ取得
$sim->yuwakashi_houhou = $yuwakashi_houhou;
$sim->yuwakashi_kaisuu = $yuwakashi_kaisuu;
$sim->yuwakashi_ryou = $yuwakashi_ryou;
$sim->hoon_houhou = $hoon_houhou;
$sim->hoon_jikan = $hoon_jikan;
$sim->yuwakashi_houhou_e = $yuwakashi_houhou_e;
$sim->hoon_houhou_e = $hoon_houhou_e;
$sim->hoon_jikan_e = $hoon_jikan_e;
	...
	<tr>
		...
		<td align="center" valign="top">
			...
			<table border="0" cellpadding="0" cellspacing="2">
				<tr>
					<td>
						<img src="img/shindan/title/kekka_yuwakashi.gif" border="0" width="397" height="58">
					</td>
				</tr>
			</table>
			...
			<!-- ここに入力 -->
			<font size=4 color="#4842ff"><b>あなたの家の湯沸し方法を変えると、次のような効果があります！</b></font>
			<br><br>
			...
			<form name="form1" action="kesshin.php" method="post">
				<table border="0" width=650>
					<tr>
						<td align="center">
							<img src="img/shindan/conte/054.gif" border="0" width="300" height="165">
						</td>
					</tr>
					<tr>
...
?>
							<?=$msg?><br><br>
							<input type="hidden" name="ganbalist_id" <?=value(GANBA_YUWAKASHI)?>>
