...
// フォームからデータ取得
$sim->ninzuu_summer = $ninzuu_summer;
$sim->ninzuu_sp_aut = $ninzuu_sp_aut;
$sim->ninzuu_winter = $ninzuu_winter;
$sim->yuon_summer = $yuon_summer;
$sim->yuon_sp_aut = $yuon_sp_aut;
$sim->yuon_winter = $yuon_winter;
$sim->nyuuyoku_kankaku = $nyuuyoku_kankaku;
$sim->yokusou_futa = $yokusou_futa;
$sim->yuhari_ryou = $yuhari_ryou;
$sim->boiler_type = $boiler_type;
$sim->nyuuyoku_kankaku_e = $nyuuyoku_kankaku_e;
$sim->yokusou_futa_e = $yokusou_futa_e;
	...
	<tr>
		...
		<td align="center" valign="top">
			...
			<table border="0" cellpadding="0" cellspacing="2">
				<tr>
					<td>
						<img src="img/shindan/title/kekka_nyuyoku_01.gif" border="0" width="403" height="57">
					</td>
				</tr>
			</table>
			...
			<!-- ここに入力 -->
			<font size=4 color="#4842ff"><b>あなたの家の入浴時の浴槽追い炊き方法を変えると、<br>次のような効果があります！ </b></font>
			<br><br>
			...
			<form name="form1" action="kesshin.php" method="post">
				<table border="0" width=650>
					<tr>
						<td align="center">
							<img src="img/shindan/conte/042.gif" border="0" width="300" height="200">
						</td>
					</tr>
					<tr>
...
?>
							<?=$msg?><br><br>
							<input type="hidden" name="ganbalist_id" <?=value(GANBA_OIDAKI)?>>
