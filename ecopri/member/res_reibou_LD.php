...
// フォームからデータ取得
$sim->cooler_type = $cooler_type;
$sim->temperature = $temperature;
$sim->hours1 = $hours1;
$sim->hours2 = $hours2;
$sim->hours3 = $hours3;
$sim->cooler_type_e = $cooler_type_e;
$sim->temperature_e = $temperature_e;
$sim->hours1_e = $hours1_e;
$sim->hours2_e = $hours2_e;
$sim->hours3_e = $hours3_e;
	...
	<tr>
		...
		<td align="center" valign="top">
			...
			<table border="0" cellpadding="0" cellspacing="2">
				<tr>
					<td>
						<img src="img/shindan/title/kekka_reibou_02.gif" border="0" width="425" height="58">
					</td>
				</tr>
			</table>
			...
			<!-- ここに入力 -->
			<font size=4 color="#4842ff"><b>あなたの家の冷房方法を変えると、次のような効果があります！</b></font>
			<br><br>
			...
			<form name="form1" action="kesshin.php" method="post">
				<table border="0" width=650>
					<tr>
						<td align="center">
							<img src="img/shindan/conte/029.gif" border="0" width="300" height="200">
						</td>
					</tr>
					<tr>
...
?>
							<?=$msg?><br><br>
							<input type="hidden" name="ganbalist_id" <?=value(GANBA_REIBOU_LD)?>>
