...
// フォームからデータ取得
$sim->car_cd = $car_cd;
$sim->engine_vol = $engine_vol;
$sim->kyori = $kyori;
$sim->idling = $idling;
$sim->kyori_e = $kyori_e;
$sim->idling_e = $idling_e;
	...
	<tr>
		...
		<td align="center" valign="top">
			...
			<table border="0" cellpadding="0" cellspacing="2">
				<tr>
					<td>
						<img src="img/shindan/title/kekka_gasoline.gif" border="0" width="443" height="57">
					</td>
				</tr>
			</table>
			...
			<!-- ここに入力 -->
			<font size=4 color="#4842ff"><b>あなたの車の運転方法を変えると、次のような効果があります！</b></font>
			<br><br>
			...
			<form name="form1" action="kesshin.php" method="post">
				<table border="0" width=650>
					<tr>
						<td align="center">
							<img src="img/shindan/conte/070.gif" border="0" width="300" height="200">
						</td>
					</tr>
					<tr>
						<td align="center" valign="top">
...
?>
							<?=$msg?><br><br>
							<input type="hidden" name="ganbalist_id" <?=value(GANBA_UNTENHOUHOU)?>>
