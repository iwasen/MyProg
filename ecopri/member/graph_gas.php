...
/* 	グラフに打つそれぞれの点の高さ */
for($i = 0; $i < 12; $i++) {
	$fv[] = "gasM" . ($i + 1) . "spend=" . $use_cy_ary[$i]['gas'];
	$fv[] = "LYgasM" . ($i + 1) . "spend=" . $use_ly_ary[$i]['gas'];
	$fv[] = "input" . ($i + 1) . "=" . $status_ary[$i]['gas'];
}
...
<table>
	<tr>
		<td align="center">
			<img src="img/graph/title/graph_gas.gif" width="279" height="34" alt="ガスの推移グラフ">
			<br>
			...
			<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=5,0,0,0" width="540" height="300">
			    <param name=movie value="flash/graph/graph_gas<?=$graph?>.swf">
			    <param name=quality value=high>
			    <embed src="flash/graph/graph_gas<?=$graph?>.swf" quality=high pluginspage="http://www.macromedia.com/jp/shockwave/download/index.cgi?P1_Prod_Version=ShockwaveFlash" type="application/x-shockwave-flash" width="540" height="300" FlashVars="<?=$fv?>"></embed>
...
<table width="50%" border="0" cellspacing="0" cellpadding="0">
	<tr>
		<td align="center"><img src="img/graph/eng_comment/gas_<?=$rank['gas']?>.gif" width=434 height=82 alt="ガスコメント"></td>
	</tr>
</table>
<hr width="90%">
<br>
