...
while ($d <= $ed) {
	...
	if (date('m', $d) == $month) {
		...
		$input2 = commit_check($gl_sum[$i], 'gl_sum', $reg->commit_flag, 8, 5) . "</td><td>円";
		$i++;
	} else {
		$color = 'gray';
		$bgcolor = '#FFFFFF';
...
?>
			<table width=90%>
				<tr>
					<td align="right"><a href="result_gl_q.php"><img src="img/result_input/calendar/no_input.gif" alt="今月は入力しない" border=0></a></td>
				</tr>
			</table>
<?
}
