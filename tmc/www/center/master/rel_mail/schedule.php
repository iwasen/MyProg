...
// 登録済み配信予定日取得
$sql = "SELECT to_char(rld_send_date, 'YYYY/MM/DD') AS ymd,to_char(rld_send_date, 'HH24') AS hour,to_char(rld_send_date, 'MI') AS minute FROM t_relation_date ORDER BY rld_send_date";
$result = db_exec($sql);
...
function onSubmit_form1(f) {
	return confirm("継続リレーションメールの配信日を登録します。よろしいですか？");
}
//-->
</script>
</head>
...
<table border=0 cellpadding=0 cellspacing=1 width="100%">
	<tr>
		<td>■継続リレーションメールの配信日時を設定してください。</td>
		<td align="right">
