...
?>
	<tr class="tc<?=$i % 2?>">
		...
		<td><a href="javascript:onclick_subject(<?=$fetch->cml_comm_id?>,<?=$fetch->cml_user_id?>)" title="メールの内容を表示します"><?=$fetch->cmc_subject != '' ? htmlspecialchars($fetch->cmc_subject) : '（件名無し）'?></a></td>
