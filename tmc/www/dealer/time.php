...
<tr>
	<td align="right"><a href="thread.php?user_id=<?=$user_id?>" title="スレッド表示">スレッド表示</a></td>
</tr>
</table>
...
<?
$sql = "SELECT cml_comm_id,cml_user_id,cml_date,cml_send_recv,cmc_subject,cmc_comm_type,ups_name_kanji,stf_name"
		. " FROM t_comm_log"
...
for ($i = 0; $i < $nrow; $i++) {
	...
	$seq_no = sprintf('%03d', $i + 1);
	$seq_ary[$fetch->cml_comm_id] = $seq_no;
?>
