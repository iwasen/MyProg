================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: LLog プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した LLog には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには LLog アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
LLog.h
   ...
   CLLogApp アプリケーション クラスを宣言します。

LLog.cpp
   これは、アプリケーション クラス CLLogApp を含むメイン アプリケー
   ション ソース ファイルです。
...
res\LLog.ico
   ...
   アイコンはメイン リソース ファイル LLog.rc に含まれていま
   す。
...
LLogDlg.h, LLogDlg.cpp - ダイアログ
   これらのファイルは CLLogDlg クラスを含みます。このクラスはアプ
   リケーションのメイン ダイアログの動作を定義します。ダイアログ テンプレートは
   Microsoft Visual C++ で編集可能な LLog.rc に含まれます。
...
StdAfx.h, StdAfx.cpp
   ...
   LLog.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
