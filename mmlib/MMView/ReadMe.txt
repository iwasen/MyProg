========================================================================
       MICROSOFT FOUNDATION CLASS ライブラリ : MMView
========================================================================


AppWizard が生成した MMView には、Microsoft Foundation Class の基本的な
使い方が示されています。アプリケーション作成のひな型としてお使いください。

このファイルには MMView を構成している各ファイルの概要説明が含まれています。
...
MMView.h
    ...
    みます） をインクルードし、また CMMViewApp アプリケーションクラスを宣
    言します。

MMView.cpp
    このファイルは CMMViewApp アプリケーションクラスを含むアプリケーション
    の中心となるソースファイルです。
...
res\MMView.ico
    ...
    ルです。このアイコンはリソース ファイル MMView.rc によってインクルード
    されます。
...
res\Toolbar.bmp
    ...
    リソースエディタで編集し、MMView.rc ファイル内の IDR_MAINFRAME TOOLBAR 配列を
    変更してください。
/////////////////////////////////////////////////////////////////////////////

AppWizard は 1 つのドキュメントタイプと 1 つのビューを作成します。

MMViewDoc.h, MMViewDoc.cpp - ドキュメント
    これらのファイルは CMMViewDoc クラスを含みます。特別なドキュメント デ
    ータを付け加えたり、CMMViewDoc::Serialize を使ったファイルのセーブや
    ロード機能をインプリメントしたいときはこのファイルを編集してください。

MMPictView.h, MMPictView.cpp - ビュー
    これらのファイルは CMMPictView クラスを含みます。
    CMMPictView オブジェクトは CMMViewDoc オブジェクトを表示するために
    使います。
...
StdAfx.h, StdAfx.cpp
    これらのファイルはプリコンパイル済ヘッダー ファイル (PCH) MMView.pch 
