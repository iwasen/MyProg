...
[Files]
Source: "..\x64\JpnRel\MMLIB.exe"; DestDir: "{app}"; Flags: ignoreversion
...
Source: "..\x64\JpnRel\CapDll.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\x64\JpnRel\TWainDll.dll"; DestDir: "{app}"; Flags: ignoreversion
