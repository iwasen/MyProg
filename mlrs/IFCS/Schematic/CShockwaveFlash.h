// CShockwaveFlash.h  : Microsoft Visual C++ で作成された ActiveX コントロール ラッパー クラスの宣言です。
...
public:
	...
	{
		static BYTE pxxxs[] = VTS_BOOL ;
		InvokeHelper(0x7d, DISPATCH_PROPERTYPUT, VT_EMPTY, NULL, pxxxs, newValue);
	}
	long get_Quality()
	{
		long result;
	...
	{
		static BYTE pxxxs[] = VTS_I4 ;
		InvokeHelper(0x69, DISPATCH_PROPERTYPUT, VT_EMPTY, NULL, pxxxs, newValue);
	}
	long get_ScaleMode()
	{
		long result;
	...
	{
		static BYTE pxxxs[] = VTS_I4 ;
		InvokeHelper(0x78, DISPATCH_PROPERTYPUT, VT_EMPTY, NULL, pxxxs, newValue);
	}
	long get_AlignMode()
	{
		long result;
	...
	{
		static BYTE pxxxs[] = VTS_I4 ;
		InvokeHelper(0x79, DISPATCH_PROPERTYPUT, VT_EMPTY, NULL, pxxxs, newValue);
	}
	...
	{
		static BYTE pxxxs[] = VTS_I4 ;
		InvokeHelper(0x7b, DISPATCH_PROPERTYPUT, VT_EMPTY, NULL, pxxxs, newValue);
	}
	BOOL get_Loop()
	{
		BOOL result;
	...
	{
		static BYTE pxxxs[] = VTS_BOOL ;
		InvokeHelper(0x6a, DISPATCH_PROPERTYPUT, VT_EMPTY, NULL, pxxxs, newValue);
	}
	CString get_Movie()
	{
		CString result;
	...
	{
		static BYTE pxxxs[] = VTS_BSTR ;
		InvokeHelper(0x66, DISPATCH_PROPERTYPUT, VT_EMPTY, NULL, pxxxs, newValue);
	}
	long get_FrameNum()
	{
		long result;
	...
	{
		static BYTE pxxxs[] = VTS_I4 ;
		InvokeHelper(0x6b, DISPATCH_PROPERTYPUT, VT_EMPTY, NULL, pxxxs, newValue);
	}
	void SetZoomRect(long left, long top, long right, long bottom)
	{
		static BYTE pxxxs[] = VTS_I4 VTS_I4 VTS_I4 VTS_I4 ;
		InvokeHelper(0x6d, DISPATCH_METHOD, VT_EMPTY, NULL, pxxxs, left, top, right, bottom);
	}
	void Zoom(long factor)
	{
		static BYTE pxxxs[] = VTS_I4 ;
		InvokeHelper(0x76, DISPATCH_METHOD, VT_EMPTY, NULL, pxxxs, factor);
	}
	void Pan(long x, long y, long mode)
	{
		static BYTE pxxxs[] = VTS_I4 VTS_I4 VTS_I4 ;
		InvokeHelper(0x77, DISPATCH_METHOD, VT_EMPTY, NULL, pxxxs, x, y, mode);
	}
	void Play()
	{
	...
	{
		static BYTE pxxxs[] = VTS_I4 ;
		InvokeHelper(0x7f, DISPATCH_METHOD, VT_EMPTY, NULL, pxxxs, FrameNum);
	}
	long CurrentFrame()
	{
		long result;
	...
	BOOL FrameLoaded(long FrameNum)
	{
		BOOL result;
		static BYTE pxxxs[] = VTS_I4 ;
		InvokeHelper(0x83, DISPATCH_METHOD, VT_BOOL, (void*)&result, pxxxs, FrameNum);
		return result;
	}
	long FlashVersion()
	{
	...
	{
		static BYTE pxxxs[] = VTS_BSTR ;
		InvokeHelper(0x85, DISPATCH_PROPERTYPUT, VT_EMPTY, NULL, pxxxs, newValue);
	}
	CString get_SAlign()
	{
		CString result;
	...
	{
		static BYTE pxxxs[] = VTS_BSTR ;
		InvokeHelper(0x86, DISPATCH_PROPERTYPUT, VT_EMPTY, NULL, pxxxs, newValue);
	}
	BOOL get_Menu()
	{
		BOOL result;
	...
	{
		static BYTE pxxxs[] = VTS_BOOL ;
		InvokeHelper(0x87, DISPATCH_PROPERTYPUT, VT_EMPTY, NULL, pxxxs, newValue);
	}
	CString get_Base()
	{
		CString result;
	...
	{
		static BYTE pxxxs[] = VTS_BSTR ;
		InvokeHelper(0x88, DISPATCH_PROPERTYPUT, VT_EMPTY, NULL, pxxxs, newValue);
	}
	CString get_Scale()
	{
		CString result;
	...
	{
		static BYTE pxxxs[] = VTS_BSTR ;
		InvokeHelper(0x89, DISPATCH_PROPERTYPUT, VT_EMPTY, NULL, pxxxs, newValue);
	}
	BOOL get_DeviceFont()
	{
		BOOL result;
	...
	{
		static BYTE pxxxs[] = VTS_BOOL ;
		InvokeHelper(0x8a, DISPATCH_PROPERTYPUT, VT_EMPTY, NULL, pxxxs, newValue);
	}
	BOOL get_EmbedMovie()
	{
		BOOL result;
	...
	{
		static BYTE pxxxs[] = VTS_BOOL ;
		InvokeHelper(0x8b, DISPATCH_PROPERTYPUT, VT_EMPTY, NULL, pxxxs, newValue);
	}
	CString get_BGColor()
	{
		CString result;
	...
	{
		static BYTE pxxxs[] = VTS_BSTR ;
		InvokeHelper(0x8c, DISPATCH_PROPERTYPUT, VT_EMPTY, NULL, pxxxs, newValue);
	}
	...
	{
		static BYTE pxxxs[] = VTS_BSTR ;
		InvokeHelper(0x8d, DISPATCH_PROPERTYPUT, VT_EMPTY, NULL, pxxxs, newValue);
	}
	void LoadMovie(long layer, LPCTSTR url)
	{
		static BYTE pxxxs[] = VTS_I4 VTS_BSTR ;
		InvokeHelper(0x8e, DISPATCH_METHOD, VT_EMPTY, NULL, pxxxs, layer, url);
	}
	void TGotoFrame(LPCTSTR target, long FrameNum)
	{
		static BYTE pxxxs[] = VTS_BSTR VTS_I4 ;
		InvokeHelper(0x8f, DISPATCH_METHOD, VT_EMPTY, NULL, pxxxs, target, FrameNum);
	}
	void TGotoLabel(LPCTSTR target, LPCTSTR label)
	{
		static BYTE pxxxs[] = VTS_BSTR VTS_BSTR ;
		InvokeHelper(0x90, DISPATCH_METHOD, VT_EMPTY, NULL, pxxxs, target, label);
	}
	long TCurrentFrame(LPCTSTR target)
	{
		long result;
		static BYTE pxxxs[] = VTS_BSTR ;
		InvokeHelper(0x91, DISPATCH_METHOD, VT_I4, (void*)&result, pxxxs, target);
		return result;
	}
	CString TCurrentLabel(LPCTSTR target)
	{
		CString result;
		static BYTE pxxxs[] = VTS_BSTR ;
		InvokeHelper(0x92, DISPATCH_METHOD, VT_BSTR, (void*)&result, pxxxs, target);
		return result;
	}
	void TPlay(LPCTSTR target)
	{
		static BYTE pxxxs[] = VTS_BSTR ;
		InvokeHelper(0x93, DISPATCH_METHOD, VT_EMPTY, NULL, pxxxs, target);
	}
	void TStopPlay(LPCTSTR target)
	{
		static BYTE pxxxs[] = VTS_BSTR ;
		InvokeHelper(0x94, DISPATCH_METHOD, VT_EMPTY, NULL, pxxxs, target);
	}
	void SetVariable(LPCTSTR name, LPCTSTR value)
	{
		static BYTE pxxxs[] = VTS_BSTR VTS_BSTR ;
		InvokeHelper(0x97, DISPATCH_METHOD, VT_EMPTY, NULL, pxxxs, name, value);
	}
	CString GetVariable(LPCTSTR name)
	{
		CString result;
		static BYTE pxxxs[] = VTS_BSTR ;
		InvokeHelper(0x98, DISPATCH_METHOD, VT_BSTR, (void*)&result, pxxxs, name);
		return result;
	}
	void TSetProperty(LPCTSTR target, long property, LPCTSTR value)
	{
		static BYTE pxxxs[] = VTS_BSTR VTS_I4 VTS_BSTR ;
		InvokeHelper(0x99, DISPATCH_METHOD, VT_EMPTY, NULL, pxxxs, target, property, value);
	}
	CString TGetProperty(LPCTSTR target, long property)
	{
		CString result;
		static BYTE pxxxs[] = VTS_BSTR VTS_I4 ;
		InvokeHelper(0x9a, DISPATCH_METHOD, VT_BSTR, (void*)&result, pxxxs, target, property);
		return result;
	}
	void TCallFrame(LPCTSTR target, long FrameNum)
	{
		static BYTE pxxxs[] = VTS_BSTR VTS_I4 ;
		InvokeHelper(0x9b, DISPATCH_METHOD, VT_EMPTY, NULL, pxxxs, target, FrameNum);
	}
	void TCallLabel(LPCTSTR target, LPCTSTR label)
	{
		static BYTE pxxxs[] = VTS_BSTR VTS_BSTR ;
		InvokeHelper(0x9c, DISPATCH_METHOD, VT_EMPTY, NULL, pxxxs, target, label);
	}
	void TSetPropertyNum(LPCTSTR target, long property, double value)
	{
		static BYTE pxxxs[] = VTS_BSTR VTS_I4 VTS_R8 ;
		InvokeHelper(0x9d, DISPATCH_METHOD, VT_EMPTY, NULL, pxxxs, target, property, value);
	}
	double TGetPropertyNum(LPCTSTR target, long property)
	{
		double result;
		static BYTE pxxxs[] = VTS_BSTR VTS_I4 ;
		InvokeHelper(0x9e, DISPATCH_METHOD, VT_R8, (void*)&result, pxxxs, target, property);
		return result;
	}
	double TGetPropertyAsNumber(LPCTSTR target, long property)
	{
		double result;
		static BYTE pxxxs[] = VTS_BSTR VTS_I4 ;
		InvokeHelper(0xac, DISPATCH_METHOD, VT_R8, (void*)&result, pxxxs, target, property);
		return result;
	}
	...
	{
		static BYTE pxxxs[] = VTS_BSTR ;
		InvokeHelper(0x9f, DISPATCH_PROPERTYPUT, VT_EMPTY, NULL, pxxxs, newValue);
	}
	...
	{
		static BYTE pxxxs[] = VTS_BSTR ;
		InvokeHelper(0xaa, DISPATCH_PROPERTYPUT, VT_EMPTY, NULL, pxxxs, newValue);
	}
	...
	{
		static BYTE pxxxs[] = VTS_BSTR ;
		InvokeHelper(0xab, DISPATCH_PROPERTYPUT, VT_EMPTY, NULL, pxxxs, newValue);
	}
	...
	{
		static BYTE pxxxs[] = VTS_BSTR ;
		InvokeHelper(0xbe, DISPATCH_PROPERTYPUT, VT_EMPTY, NULL, pxxxs, newValue);
	}
	...
	{
		static BYTE pxxxs[] = VTS_UNKNOWN ;
		InvokeHelper(0xbf, DISPATCH_PROPERTYPUT, VT_EMPTY, NULL, pxxxs, newValue);
	}
	...
	{
		static BYTE pxxxs[] = VTS_BOOL ;
		InvokeHelper(0xc0, DISPATCH_PROPERTYPUT, VT_EMPTY, NULL, pxxxs, newValue);
	}
	...
	{
		static BYTE pxxxs[] = VTS_BOOL ;
		InvokeHelper(0xc2, DISPATCH_PROPERTYPUT, VT_EMPTY, NULL, pxxxs, newValue);
	}
	...
	{
		static BYTE pxxxs[] = VTS_BSTR ;
		InvokeHelper(0xc3, DISPATCH_PROPERTYPUT, VT_EMPTY, NULL, pxxxs, newValue);
	}
	...
	{
		static BYTE pxxxs[] = VTS_I4 ;
		InvokeHelper(0xc4, DISPATCH_PROPERTYPUT, VT_EMPTY, NULL, pxxxs, newValue);
	}
	CString CallFunction(LPCTSTR request)
	{
		CString result;
		static BYTE pxxxs[] = VTS_BSTR ;
		InvokeHelper(0xc6, DISPATCH_METHOD, VT_BSTR, (void*)&result, pxxxs, request);
		return result;
	}
	void SetReturnValue(LPCTSTR returnValue)
	{
		static BYTE pxxxs[] = VTS_BSTR ;
		InvokeHelper(0xc7, DISPATCH_METHOD, VT_EMPTY, NULL, pxxxs, returnValue);
	}
	...
	{
		static BYTE pxxxs[] = VTS_BSTR ;
		InvokeHelper(0xc9, DISPATCH_PROPERTYPUT, VT_EMPTY, NULL, pxxxs, newValue);
	}
	...
	{
		static BYTE pxxxs[] = VTS_BSTR ;
		InvokeHelper(0xca, DISPATCH_PROPERTYPUT, VT_EMPTY, NULL, pxxxs, newValue);
	}
