...
IMPLEMENT_DYNCREATE(CMenuFS20, CMenuCommon)
...
//		無し
//*****************************************************************************************************
CMenuFS20::CMenuFS20(CWnd* pParent /*=NULL*/)
	: CMenuCommon(CMenuFS20::IDD, pParent)
{
	m_bWorking = FALSE;
	m_bPause = FALSE;
}

void CMenuFS20::DoDataExchange(CDataExchange* pDX)
{
...
BEGIN_MESSAGE_MAP(CMenuFS20, CMenuCommon)
	ON_BN_CLICKED(IDC_BUTTON_ACTION_1, &CMenuFS20::OnBnClickedButtonAction1)
	ON_CONTROL(BN_PUSHED, IDC_BUTTON_ACTION_2, &CMenuFS20::OnBnPushedButtonAction2)
	ON_CONTROL(BN_UNPUSHED, IDC_BUTTON_ACTION_2, &CMenuFS20::OnBnUnpushedButtonAction2)
	ON_BN_CLICKED(IDC_BUTTON_ACTION_3, &CMenuFS20::OnBnClickedButtonAction3)
	ON_BN_CLICKED(IDC_BUTTON_ACTION_4, &CMenuFS20::OnBnClickedButtonAction4)
	ON_BN_CLICKED(IDC_BUTTON_ACTION_5, &CMenuFS20::OnBnClickedButtonAction5)
	ON_BN_CLICKED(IDC_BUTTON_ACTION_6, &CMenuFS20::OnBnClickedButtonAction6)
	ON_CONTROL(BN_PUSHED, IDC_BUTTON_ACTION_7, &CMenuFS20::OnBnPushedButtonAction7)
	ON_BN_CLICKED(IDC_BUTTON_ACTION_7, &CMenuFS20::OnBnClickedButtonAction7)
	ON_CONTROL(BN_PUSHED, IDC_BUTTON_ACTION_8, &CMenuFS20::OnBnPushedButtonAction8)
	ON_BN_CLICKED(IDC_BUTTON_ACTION_8, &CMenuFS20::OnBnClickedButtonAction8)
	ON_BN_CLICKED(IDC_BUTTON_ACTION_9, &CMenuFS20::OnBnClickedButtonAction9)
	ON_BN_CLICKED(IDC_BUTTON_ACTION_10, &CMenuFS20::OnBnClickedButtonAction10)
	ON_BN_CLICKED(IDC_BUTTON_ACTION_11, &CMenuFS20::OnBnClickedButtonAction11)
	ON_BN_CLICKED(IDC_BUTTON_ACTION_12, &CMenuFS20::OnBnClickedButtonAction12)
	ON_BN_CLICKED(IDC_BUTTON_ACTION_13, &CMenuFS20::OnBnClickedButtonAction13)
	ON_WM_TIMER()
END_MESSAGE_MAP()


// CMenuFS20 メッセージ ハンドラ

//*****************************************************************************************************
//  1. 関数名
//		CMenuFS20::OnInitDialog
//----------------------------------------------------------------------------------------------------
//  2. 機能
//		ダイアログ初期化処理
//----------------------------------------------------------------------------------------------------
...
//*****************************************************************************************************
//  1. 関数名
//		CMenuFS20::OnBnClickedButtonAction1
//----------------------------------------------------------------------------------------------------
//  2. 機能
//		「ブーム制御メニュー」ボタンクリック処理
//----------------------------------------------------------------------------------------------------
...
//		無し
//*****************************************************************************************************
void CMenuFS20::OnBnClickedButtonAction1()
{
	// 動作ステータス設定
...
//*****************************************************************************************************
//  1. 関数名
//		CMenuFS20::OnBnPushedButtonAction2
//----------------------------------------------------------------------------------------------------
//  2. 機能
//		「使用可表示灯」ボタンクリック処理
//----------------------------------------------------------------------------------------------------
...
//		無し
//*****************************************************************************************************
void CMenuFS20::OnBnPushedButtonAction2()
{
	// Flashへ操作指示送信
...
//*****************************************************************************************************
//  1. 関数名
//		CMenuFS20::OnBnUnpushedButtonAction2
//----------------------------------------------------------------------------------------------------
//  2. 機能
//		「使用可表示灯」ボタンリリース処理
//----------------------------------------------------------------------------------------------------
...
//		無し
//*****************************************************************************************************
void CMenuFS20::OnBnUnpushedButtonAction2()
{
	// Flashへ操作指示送信
...
//*****************************************************************************************************
//  1. 関数名
//		CMenuFS20::OnBnClickedButtonAction3
//----------------------------------------------------------------------------------------------------
//  2. 機能
//		「ブーム選択スイッチ」ボタンクリック処理
//----------------------------------------------------------------------------------------------------
...
//		無し
//*****************************************************************************************************
void CMenuFS20::OnBnClickedButtonAction3()
{
	// 動作ステータス設定
...
//*****************************************************************************************************
//  1. 関数名
//		CMenuFS20::OnBnClickedButtonAction4
//----------------------------------------------------------------------------------------------------
//  2. 機能
//		「左」ボタンクリック処理
//----------------------------------------------------------------------------------------------------
...
//		無し
//*****************************************************************************************************
void CMenuFS20::OnBnClickedButtonAction4()
{
	// 動作ステータス設定
...
//*****************************************************************************************************
//  1. 関数名
//		CMenuFS20::OnBnClickedButtonAction5
//----------------------------------------------------------------------------------------------------
//  2. 機能
//		「同時」ボタンクリック処理
//----------------------------------------------------------------------------------------------------
...
//		無し
//*****************************************************************************************************
void CMenuFS20::OnBnClickedButtonAction5()
{
	// 動作ステータス設定
...
//*****************************************************************************************************
//  1. 関数名
//		CMenuFS20::OnBnClickedButtonAction6
//----------------------------------------------------------------------------------------------------
//  2. 機能
//		「右」ボタンクリック処理
//----------------------------------------------------------------------------------------------------
...
//		無し
//*****************************************************************************************************
void CMenuFS20::OnBnClickedButtonAction6()
{
	// 動作ステータス設定
...
//*****************************************************************************************************
//  1. 関数名
//		CMenuFS20::OnBnPushedButtonAction7
//----------------------------------------------------------------------------------------------------
//  2. 機能
//		「ブーム縮」ボタンプッシュ処理
//----------------------------------------------------------------------------------------------------
...
//		無し
//*****************************************************************************************************
void CMenuFS20::OnBnPushedButtonAction7()
{
	// Flashへ操作指示送信
...
//*****************************************************************************************************
//  1. 関数名
//		CMenuFS20::OnBnClickedButtonAction7
//----------------------------------------------------------------------------------------------------
//  2. 機能
//		「ブーム縮」ボタンクリック処理
//----------------------------------------------------------------------------------------------------
...
//		無し
//*****************************************************************************************************
void CMenuFS20::OnBnClickedButtonAction7()
{
	// 動作ステータス設定
...
//*****************************************************************************************************
//  1. 関数名
//		CMenuFS20::OnBnPushedButtonAction8
//----------------------------------------------------------------------------------------------------
//  2. 機能
//		「ブーム伸」ボタンプッシュ処理
//----------------------------------------------------------------------------------------------------
...
//		無し
//*****************************************************************************************************
void CMenuFS20::OnBnPushedButtonAction8()
{
	// Flashへ操作指示送信
...
//*****************************************************************************************************
//  1. 関数名
//		CMenuFS20::OnBnClickedButtonAction8
//----------------------------------------------------------------------------------------------------
//  2. 機能
//		「ブーム伸」ボタンクリック処理
//----------------------------------------------------------------------------------------------------
...
//		無し
//*****************************************************************************************************
void CMenuFS20::OnBnClickedButtonAction8()
{
	// 動作ステータス設定
...
//*****************************************************************************************************
//  1. 関数名
//		CMenuFS20::OnBnClickedButtonAction9
//----------------------------------------------------------------------------------------------------
//  2. 機能
//		「フック上」ボタンクリック処理
//----------------------------------------------------------------------------------------------------
...
//		無し
//*****************************************************************************************************
void CMenuFS20::OnBnClickedButtonAction9()
{
	// 動作ステータス設定
...
//*****************************************************************************************************
//  1. 関数名
//		CMenuFS20::OnBnClickedButtonAction10
//----------------------------------------------------------------------------------------------------
//  2. 機能
//		「フック上停止」ボタンクリック処理
//----------------------------------------------------------------------------------------------------
...
//		無し
//*****************************************************************************************************
void CMenuFS20::OnBnClickedButtonAction10()
{
	// 動作ステータス設定
...
//*****************************************************************************************************
//  1. 関数名
//		CMenuFS20::OnBnClickedButtonAction11
//----------------------------------------------------------------------------------------------------
//  2. 機能
//		「フック下」ボタンクリック処理
//----------------------------------------------------------------------------------------------------
...
//*****************************************************************************************************
// 
void CMenuFS20::OnBnClickedButtonAction11()
{
	// 動作ステータス設定
...
//*****************************************************************************************************
//  1. 関数名
//		CMenuFS20::OnBnClickedButtonAction12
//----------------------------------------------------------------------------------------------------
//  2. 機能
//		「フック下停止」ボタンクリック処理
//----------------------------------------------------------------------------------------------------
...
//		無し
//*****************************************************************************************************
void CMenuFS20::OnBnClickedButtonAction12()
{
	// 動作ステータス設定
	SetStatus(STATUS_HOOK_STOP);
...
//*****************************************************************************************************
//  1. 関数名
//		CMenuFS20::OnBnClickedButtonAction13
//----------------------------------------------------------------------------------------------------
//  2. 機能
//		「一時停止」ボタンクリック処理
//----------------------------------------------------------------------------------------------------
...
//		無し
//*****************************************************************************************************
void CMenuFS20::OnBnClickedButtonAction13()
{
	// 「低速」「通常」ボタンの有効化
...
//		無し
//*****************************************************************************************************
void CMenuFS20::SendAction(int nActionNo, int nParam2)
{
	CUIntArray aParams;
...
//		無し
//*****************************************************************************************************
void CMenuFS20::ActionEnd(int nActionNo)
{
	if (m_bWorking) {
		switch (nActionNo) {
		case ACTION_9:
...
//		無し
//*****************************************************************************************************
void CMenuFS20::SetStatus(EStatus eStatus, BOOL bWorking)
{
	// 動作ステータス設定
	m_eStatus = eStatus;
	m_bWorking |= bWorking;
...
//		無し
//*****************************************************************************************************
void CMenuFS20::OnTimer(UINT_PTR nIDEvent)
{
	switch (nIDEvent) {
