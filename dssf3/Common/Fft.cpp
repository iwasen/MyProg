...
void CFFT::fft(int n, double x[], double y[])
{
	fft_sub(n, x, y, -1);
}

void CFFT::ifft(int n, double x[], double y[])
{
	fft_sub(n, x, y, 1);
}

void CFFT::fft_sub(int n, double x[], double y[], int isgn)
{
	if (last_n != n) {
		if (a != NULL) {
			delete [] a;
...
void CRFFT::fft(int n, double *fp)
{
	fft_sub(n, fp, 1);
}

void CRFFT::ifft(int n, double *fp)
{
	fft_sub(n, fp, -1);
}
...
void cftfsub(int n,	double *a, const double *w)
{
	int j, j1, j2, j3, l;
...
void cftbsub(int n,	double *a, const double *w)
{
	int j, j1, j2, j3, l;
	double x0r,	x0i, x1r, x1i, x2r,	x2i, x3r, x3i;
...
void cft1st(int n, double *a, const double *w)
{
	int j, k1, k2;
...
void cftmdl(int n, int l, double *a, const double *w)
{
...
void rftfsub(int n, double *a, int nc, const double *c)
{
    int j, k, kk, ks, m;
...
void rftbsub(int n, double *a, int nc, const double *c)
{
    int j, k, kk, ks, m;
    double wkr, wki, xr, xi, yr, yi;
