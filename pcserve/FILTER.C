...
static	BOOL	_CheckSelect(PDB, CHAR *, CHAR *);
...
static BOOL wildmat(char *s, char *p);
static BOOL Star(char *s, char *p);
...
static	BOOL	_CheckSelect(PDB dbp, CHAR *select, CHAR *cp)
{
	CHAR	*p, *cp2;
	int	indexNo;
	CHAR	value[256];
