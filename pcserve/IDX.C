...
static	SHORT	_IDXPack(CHAR *, PIDX, int, int, LONG *, CHAR *, BOOL *,
							LONG *, LONG *);
...
static	SHORT	_IDXOpen(CHAR *fileName, PIDX *ipp)
{
	...
	for (ifp = pTopIDX_F; ifp != NULL; ifp = ifp->chain) {
		if (strcmp(pathName, ifp->fileName) == 0)
			break;
	}
	...
	if (ifp == NULL) {
		...
		strcpy(ifp->fileName, pathName);	/* ファイル名セーブ */
...
/*=======================================================================
 ...
 |
 =======================================================================*/
SHORT	IDXFlush(PIDX ip, BOOL bReopen)
{
	PIDX_F	ifp;
#if defined (OS_WNT) && !defined (_SERVER)
	DWORD	numBytes;
...
/*=======================================================================
 ...
 |
 =======================================================================*/
VOID	IDXFlushBlock(PIDX ip, BOOL bSelf)
{
	PIDX	ipTmp;
	PIDX_B	bp;
...
/*=======================================================================
 ...
 |
 =======================================================================*/
static	SHORT	_IDXPack(CHAR *fileName, PIDX ip, int fh, int level,
					LONG *nBlock, CHAR *key, BOOL *keyFlag,
					LONG *bno, LONG *rno)
{
	PIDX_F	ifp;
	PIDX_H	ihp;
