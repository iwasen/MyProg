...
?>
	<tr class="tc<?=$i % 2?>">
		<td align="center"><a href="edit.php?adv_id=<?=$fetch->at_adv_id?>" title="広告タイプマスタ情報を表示・変更します"><?=$fetch->at_order?></a></td>
