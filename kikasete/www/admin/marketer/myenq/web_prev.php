...
set_global('myenquete', 'Ｍｙアンケート管理', 'Ｗｅｂプレビュー', BACK_TOP);
...
<table width="470" border="0" cellpadding="2" cellspacing="0" bgcolor="#c8c8c8">
	<tr>
		<td><font size="2"><table border="0" cellpadding="5" cellspacing="0" width="100%">
				<tr>
					<td bgcolor="#c3c2ff" colspan="2"><font color="#2b2b63" size="2"><b><?=htmlspecialchars($enquete->title)?></b></font>についてのアンケート</td>
				</tr>
				<tr>
