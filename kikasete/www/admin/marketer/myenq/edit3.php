...
<table border=0 cellspacing=2 cellpadding=3 width="80%">
	<tr>
		<td class="m0">■条件の設定</td>
	</tr>
	<tr>
		<td class="m1" width="25%">最大発信数</td>
...
?>
	...
	<tr id="tr_cell" style="display:none">
		...
		<td class="n1">
				...
				<tr id="area1" style="display:none">
					<td>
						<table border=1 cellspacing=0 cellpadding=2 width=40% frame="box">
							<tr>
								<td class="m1">男性</td>
								<td class="n1" align="center"><input type="text" <?=cell_name_value(1, 1, 0)?> size="5" onblur="calc_cell_num()"></td>
							</tr>
							<tr>
								<td class="m1">女性</td>
								<td class="n1" align="center"><input type="text" <?=cell_name_value(1, 2, 0)?> value="" size="5" onblur="calc_cell_num()"></td>
							</tr>
						</table>
					</td>
				</tr>
				...
				<tr id="area2" style="display:none">
					<td>
						<table border=1 cellspacing=0 cellpadding=2 width=100% frame="box">
							...
							<tr>
								<td class="m1" colspan="2"><input type="radio" name="sex_option2" <?=value_checked(1, $cell->sex_option)?> onclick="onclick_sex_option()">性別<br>指定なし</td>
			<?
			for ($i = 3; $i <= 14; $i++) {
			?>
								<td class="n1" align="center"><input type="text" <?=cell_name_value(2, 0, $i)?> size="3" onblur="calc_cell_num()"></td>
			<?
			}
			?>
							</tr>
			...
			for ($i = 3; $i <= 14; $i++) {
			?>
								<td class="n1" align="center"><input type="text" <?=cell_name_value(2, 1, $i)?> size="3" onblur="calc_cell_num()"></td>
			<?
			}
			?>
							</tr>
			...
			for ($i = 3; $i <= 14; $i++) {
			?>
								<td class="n1" align="center"><input type="text" <?=cell_name_value(2, 2, $i)?> size="3" onblur="calc_cell_num()"></td>
			<?
			}
			?>
							</tr>
			...
			for ($i = 2; $i <= 8; $i++) {
			?>
								<td class="n1" align="center"><input type="text" <?=cell_name_value(3, 0, $i)?> size="5" onblur="calc_cell_num()"></td>
			<?
			}
			?>
							</tr>
			...
			for ($i = 2; $i <= 8; $i++) {
			?>
								<td class="n1" align="center"><input type="text" <?=cell_name_value(3, 1, $i)?> size="5" onblur="calc_cell_num()"></td>
			<?
			}
			?>
							</tr>
			...
			for ($i = 2; $i <= 8; $i++) {
			?>
								<td class="n1" align="center"><input type="text" <?=cell_name_value(3, 2, $i)?> size="5" onblur="calc_cell_num()"></td>
			<?
			}
			?>
							</tr>
...
?>
	<tr>
		<td class="m1"><?=htmlspecialchars($category_name)?></td>
		<td class="n1">
			...
			<span id="special_panel<?=$category_id?>_c">&nbsp;
				...
				<input type="button" value="全解除" onclick="all_check(<?="'special_panel[$category_id][]'"?>,false)">
<?
