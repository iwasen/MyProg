...
$sql = "SELECT mn_monitor_id,mn_mail_addr,mn_name1,mn_name2"
		. " FROM t_myenq_member_list JOIN t_monitor ON mn_monitor_id=mml_monitor_id"
		. " WHERE mml_group_id=$group_id $order_by";
$result = db_exec($sql);
