...
set_global($class, $section, 'メンバーリスト変更', BACK_TOP);

$sql = "SELECT * FROM t_myenq_member_grp WHERE mmg_group_id = $group_id";
$result = db_exec($sql);
...
<table border=0 cellspacing=2 cellpadding=3 width="80%">
	...
	<tr>
		...
		<td class="n1">
			<input class="kanji" type="text" name="group_name" size=50 <?=value($fetch->mmg_group_name)?>>
		</td>
	</tr>
	<tr>
		<td class="m1">概要</td>
		<td class="n1">
			<textarea class="kanji" name="summary" cols=50 rows=5><?=htmlspecialchars($fetch->mmg_summary)?></textarea>
		</td>
	</tr>
</table>
<br>
