...
function select_regist_type($sel) {
	echo "<option ", value_selected('0', $sel), ">全ユーザ</option>";
	echo "<option ", value_selected('1', $sel), ">媒体経由なし</option>";
	echo "<option ", value_selected('2', $sel), ">ネットマイル</option>";
}

set_global('monitor', 'モニター管理', 'モニター入退会者集計', BACK_TOP);
