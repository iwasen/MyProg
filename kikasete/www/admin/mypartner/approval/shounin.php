...
$sql = "SELECT ppj_recruit_start FROM t_mp_pjt WHERE ppj_pjt_id=$pjt_id";
$recruit_start = db_fetch1($sql);
$year = get_datepart('Y', $recruit_start);
$month = get_datepart('M', $recruit_start);
$day = get_datepart('D', $recruit_start);
$hour = get_datepart('h', $recruit_start);
?>
<html lang="ja">
<head>
