...
<table border=0 cellspacing=0 cellpadding=0>
	<tr>
		<td>
			...
			<br>
			<div align="center">
			<input type="button" value="　ログ閲覧　" onclick="location.href='log.php?job_id=<?=$job_id?>'">
			<input type="button" value="CSV取得" onclick="location.href='csv.php?job_id=<?=$job_id?>'">
			<input type="button" value="CSV取得(0,1)" onclick="location.href='csv2.php?job_id=<?=$job_id?>'">
