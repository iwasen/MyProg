...
set_global('きかせて・net エージェントログイン', BACK_NONE);
?>
<html lang="ja">
<head>
...
<form method="post" name="form1" action="login_check.php" onSubmit="return onSubmit_form1(this)">
	    ...
	    <td>
	      <table border=0 cellspacing=2 cellpadding=3 width="100%">
	        <tr>
	          ...
	          <td class="n1"><input class="alpha" type="text" name="login_id" size=30 <?=value($_COOKIE['agent_mail_addr'])?>></td>
	        </tr>
	        <tr>
  ...
  <input type="button" value="Myページ登録" onclick="location.href='<?=$top?>/regist/new.php'">
</form>
</div>
