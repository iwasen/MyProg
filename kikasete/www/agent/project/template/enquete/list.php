...
set_global2('project', 'プロジェクト管理｜テンプレート編集', '質問文テンプレート一覧', BACK_TOP);
...
?>
	<tr class="tc<?=$i % 2?>">
		...
		<td align="left">
			<a href="edit.php?pq_no=<?=$fetch->pq_seq_no?>" title="質問文テンプレートを修正します"><?=htmlspecialchars($fetch->pq_title)?></a>
		</td>
