...
// メイン処理
set_global('有料マーケター代理登録', BACK_TOP);
?>
<html lang="ja">
<head>
...
<table border=0 cellspacing=0 cellpadding=3 width=100%>
	<tr><td align="center" class="m4"><b>有料マーケター代理登録</b></td></tr>
</table>
<table border=0 cellspacing=2 cellpadding=3 width="100%">
	...
	<tr>
		...
		<td class="n1"><select name="agent_id"><? select_agent('- 未設定 -', $agent_id, AG_MAIN)?></select></td>
	</tr>
<? /*
	<tr>
