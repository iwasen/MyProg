...
<table  border="0" cellspacing="0" cellpadding="0" bgcolor="#ffffff">
	<tr>
		...
		<td width="778" align="center" valign="top">
			...
			<form method="post" name="form1" action="pe_update3.php" onsubmit="return onsubmit_form1(this)">
			<table border=0 cellspacing=2 cellpadding=3 width="90%" class="honbun2">
				<tr>
					<td bgcolor="#eff7e8">■対象条件・サンプル割付の設定</td>
				</tr>
				<tr>
					<td bgcolor="#ffffff">各項目で全て選択していない場合は、全て選択している場合と同じです。<BR>
<div class="footer_text">※　<span style="color:#FF0000;">サンプル割付、子供の有無、同居家族の指定は、<a href="pe_price.php" target="_blank">オプション料金</a>がかかります。</span></div>
</td>
				</tr>
				<tr>
					<td>
						<table border=1 cellspacing=0 cellpadding=3 width=100% frame="box" class="honbun2">
							<tr>
								<td bgcolor="#eeeeee" width="15%">本アンケート回収<br>目標サンプル数</td>
							...
							<tr>
								<td bgcolor="#eeeeee">サンプル数割付<br>（セル指定）</td>
								<td width="85%" bgcolor="#ffeecc">
...
<table border="0" cellspacing="0" cellpadding="0" align="center" width="100%">
			...
			<table border="0" cellspacing="0" cellpadding="0" width=100% class="honbun2">
				<tr>
					<td width="150" valign="bottom">
						<table border="1" cellspacing="0" cellpadding="2" width=100% class="honbun2" bgcolor="#eeeeee" style="border-bottom-style:none">
							<tr>
	...
	<tr id="area1" style="display:none">
		<td>
			<table border=1 cellspacing=0 cellpadding=2 width=40% frame="box" class="honbun2">
				<tr>
					<td bgcolor="#eeeeee">男性</td>
					<td bgcolor="#ffeecc" align="center"><input type="text" <?=cell_namep_value(1, 1, 0)?> size="5" onblur="calc_cell_num()"></td>
				</tr>
				<tr>
					<td bgcolor="#eeeeee">女性</td>
					<td bgcolor="#ffeecc" align="center"><input type="text" <?=cell_namep_value(1, 2, 0)?> value="" size="5" onblur="calc_cell_num()"></td>
				</tr>
			</table>
		</td>
	</tr>
	...
	<tr id="area2" style="display:none">
		<td>
			<table border=1 cellspacing=0 cellpadding=2 width=100% frame="box" class="honbun2">
				<tr>
...
for ($i = 3; $i <= 14; $i++) {
?>
					<td bgcolor="#ffeecc" align="center"><input type="text" <?=cell_namep_value(2, 0, $i)?> size="3" onblur="calc_cell_num()"></td>
<?
}
?>
				</tr>
...
for ($i = 3; $i <= 14; $i++) {
?>
					<td bgcolor="#ffeecc" align="center"><input type="text" <?=cell_namep_value(2, 1, $i)?> size="3" onblur="calc_cell_num()"></td>
<?
}
?>
				</tr>
...
for ($i = 3; $i <= 14; $i++) {
?>
					<td bgcolor="#ffeecc" align="center"><input type="text" <?=cell_namep_value(2, 2, $i)?> size="3" onblur="calc_cell_num()"></td>
<?
}
?>
				</tr>
...
for ($i = 2; $i <= 8; $i++) {
?>
					<td bgcolor="#ffeecc" align="center"><input type="text" <?=cell_namep_value(3, 0, $i)?> size="5" onblur="calc_cell_num()"></td>
<?
}
?>
				</tr>
...
for ($i = 2; $i <= 8; $i++) {
?>
					<td bgcolor="#ffeecc" align="center"><input type="text" <?=cell_namep_value(3, 1, $i)?> size="5" onblur="calc_cell_num()"></td>
<?
}
?>
				</tr>
...
for ($i = 2; $i <= 8; $i++) {
?>
					<td bgcolor="#ffeecc" align="center"><input type="text" <?=cell_namep_value(3, 2, $i)?> size="5" onblur="calc_cell_num()"></td>
<?
}
?>
				</tr>
	...
	<tr>
		<td>
			<table border="0" cellspacing="0" cellpadding="2" width="100%" frame="box" class="honbun2">
			<tr>
				<td width="30%">上記サンプル数合計</td><td><input type="text" name="cell_sum" size="15" readonly>サンプル</td>
			</tr>
			<tr>
				<td>サンプル数過不足自動計算</td><td><input type="text" name="cell_diff" size="15" readonly>サンプル （0になるように上記でご指定ください）</td>
			</tr>
			<tr>
	...
	<tr>
		<td><input type="submit" value="サンプル数の確認" onclick="document.form1.next_action.value='send_check'"></td>
	</tr>
</table>
								</td>
							</tr>
...
*/ ?>
							...
							<tr id="tr_send_rate" style="display:none">
								<td bgcolor="#eeeeee" rowspan=4 id="send_rate">発信割合設定</td>
								<td bgcolor="#ffeecc">
							...
							<tr id="tr_kyoju_area" style="display:none">
								<td bgcolor="#ffeecc">
<table border="0" cellspacing="0" cellpadding="0" width="100%" frame="box" class="honbun2">
<?
$cols = 3;
$col = 0;
foreach ($area3_ary as $area3_cd => $area3_name) {
...
<input type="submit" value="発信数の確認" onclick="document.form1.next_action.value='send_check2'">
			...
			<br>
			<input type="submit" value="　対象人数検索　" onclick="document.form1.next_action.value='search'">
