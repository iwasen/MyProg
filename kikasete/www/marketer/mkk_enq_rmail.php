...
?>
<? marketer_header('受信者プロファイル', PG_NULL) ?>
...
<table width="788" border="0" cellspacing="0" cellpadding="0" bgcolor="#ffffff">
	<tr>
		...
		<td width="400" valign="top">≪受信者プロファイル≫</td>
	</tr>
</table>
      <table width="788" border="0" cellspacing="0" cellpadding="0" bgcolor="#ffffff">
        <tr> 
        ...
        <tr> 
          <td> 
            <table width="768" border="0" cellspacing="0" cellpadding="0">
              <tr> 
                <td width="500" rowspan="2"> アンケートを受信したモニターのプロファイルです。<br>
        ...
        <tr> 
          <td> 
            <table width="99%" border="1" cellspacing="0" cellpadding="5" bordercolor="#c0c0c0" bordercolorlight="#c0c0c0" bordercolordark="#c0c0c0" frame="box">
              <tr bgcolor="#eeeeee"> 
                <td nowrap class="footer_text">番号</td>
                <td nowrap class="footer_text">回答日</td>
