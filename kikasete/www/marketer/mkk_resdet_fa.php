...
case 'age':
?>
					<td width="6%" align="center" bgcolor="#3300FF"><span class="style1"><nobr>年代</nobr></span></td>
<?
	break;
case 'sex':
?>
					<td width="6%" align="center" bgcolor="#3300FF"><span class="style1"><nobr>性別</nobr></span></td>
<?
	break;
case 'age_sex':
?>
					<td width="8%" align="center" bgcolor="#3300FF"><span class="style1"><nobr>年代</nobr></span></td>
					<td width="6%" align="center" bgcolor="#3300FF"><span class="style1"><nobr>性別</nobr></span></td>
<?
	break;
case 'sex_age':
...
?>
					<td width="6%" align="center" bgcolor="#3300FF"><span class="style1"><nobr>Ｑ
		            <?=$sel_qno?>
					</nobr></span></td>
<?
}
