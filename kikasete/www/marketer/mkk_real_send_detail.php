	...
	<tr>
		...
		<td width="778" align="center" valign="top">
			...
			<table width="650" border="0" cellspacing="0" cellpadding="0">
				...
				<tr>
					<td align="right">
						<a href="mkk_recv_count_detail.php?enquete_id=<?=$enquete_id?>">受信数詳細へ</a>
					</td>
				</tr>
			</table>
			<br>
						...
						<table width="500" valign="top" bgcolor="#ffffff" align="center">
							<tr>
								<td width="100%" align="center">
									<a href="mkk_enqdet1.php?enquete_id=<?=$enquete_id?>"><img src="images/mkk_bt/back.gif" alt="戻る" width="108" height="31" 
