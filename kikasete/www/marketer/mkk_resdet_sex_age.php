...
?>
			<table width="600" border="1" cellspacing="0" cellpadding="5" bordercolor="#c0c0c0" bordercolorlight="#c0c0c0" bordercolordark="#c0c0c0">
				...
				<tr>
				  <td align="right" bgcolor="#eeeeee">集計項目</td>
				  <td>性別×年代</td>
			  </tr>
			</table>
<?
...
?>
					<td width="40" align="center"><?=$age_text_ary[$age]?></td>
<?
...
?>
								<a href="mkk_resdet_fa.php?enquete_id=<?=$enquete_id?>&question_no=<?=$question_no?>&sel_no=<?=$sel_no?>&type=sex_age" target="_blank" title="新しいウィンドウで定性回答を表示します"><?=$sno?>．<?=htmlspecialchars($sel_text)?></a>
<?
					} else {
?>
