...
?>
								<a href="mkk_resdet_fa.php?enquete_id=<?=$enquete_id?>&question_no=<?=$question_no?>&sel_no=<?=$sel_no?>&type=sex" target="_blank" title="新しいウィンドウで定性回答を表示します"><?=$sno?>．<?=htmlspecialchars($sel_text)?></a>
<?
					} else {
?>
...
?>
				...
				<tr>
					<td width="670" align="center">全体</td>
<?
				for ($sel_no = 1; $sel_no <= MAX_SEL; $sel_no++) {
