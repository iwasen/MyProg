...
?>
<? marketer_header('過去のメッセージ詳細', PG_NULL) ?>
...
<table width="788" border="0" cellspacing="0" cellpadding="0" bgcolor="#ffffff">
	<tr>
		...
		<td width="400" valign="top"><img src="images/t_mkk_mdet1.gif" width="400" height="20"><br><br></td>
	</tr>
</table>
<table width="788" border="0" cellspacing="0" cellpadding="0" bgcolor="#ffffff">
	<tr>
...
?>
	<tr>
		<td>
		<form method="post" action="mkk_mdel.php">
      ...
      <table border=0 cellspacing=1 cellpadding=5 width="100%" class="nor_text">
        ...
        <tr> 
          <td bgcolor="#FFFFFF"><?=$text?></td>
				...
				<tr>
					<td align="right"><input type="image" src="images/mkk_bt/delete.gif" alt="削除" width="108" height="31">
