...
<table width="788" border="0" cellspacing="0" cellpadding="0" bgcolor="#ffffff">
	<tr>
		...
		<td align="right">
			<input type="button" value="集計結果のダウンロード" onclick="location.href='pe_csv_age_sex.php?pro_enq_no=<?=$pro_enq_no?>'"><img src="images/common/spacer.gif" width="20" height="1" border="0">
		</td>
	</tr>
</table>
<table width="788" border="0" cellspacing="0" cellpadding="0" bgcolor="#ffffff">
			...
			<table width="580" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td align="right">
						...
						<a href="pe_resdet_sex.php?pro_enq_no=<?=$pro_enq_no?>">性別</a>　｜　<a href="pe_resdet_age.php?pro_enq_no=<?=$pro_enq_no?>">年代</a>　｜　<a href="pe_resdet_sex_age.php?pro_enq_no=<?=$pro_enq_no?>">性別・年代（１０歳毎）</a>　｜　<strong>年代（５歳毎）・性別</strong>　｜　<a href="pe_enqdet1.php?pro_enq_no=<?=$pro_enq_no?>">アンケート詳細表示に戻る</a>
					</td>
				</tr>
			</table>
			<br><br>
...
?>
								<a href="pe_resdet_fa.php?pro_enq_no=<?=$pro_enq_no?>&enquete_id=<?=$enquete_id?>&question_no=<?=$question_no?>&sel_no=<?=$sel_no?>&type=age_sex" target="_blank" title="新しいウィンドウで定性回答を表示します"><?=$sno?>．<?=htmlspecialchars($sel_text)?></a>
<?
					} else {
?>
