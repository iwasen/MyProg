...
?>
<? marketer_header('設問ファイルのダウンロード', PG_NULL) ?>
	...
	<tr>
		<td>
			...
			<table width="500" border="0" cellspacing="0" cellpadding="10" bordercolor="#c0c0c0" bordercolorlight="#c0c0c0" bordercolordark="#c0c0c0">
				<tr>
					<td align="center">
						<form method="" action="mkk_enq_csv4.php">
						<input type="hidden" name="type" value="<?=$type?>">
						<input type="hidden" name="enquete_id" value="<?=$enquete_id?>">
						<input type="image" src="images/mkk_bt/dl_question.gif" alt="設問ファイルのダウンロード">
						</form>
					</td>
				</tr>
			</table>
