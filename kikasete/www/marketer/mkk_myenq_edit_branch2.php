...
<table  border="0" cellspacing="0" cellpadding="0" bgcolor="#ffffff">
	<tr>
		...
		<td width="778" align="center" valign="top">
			...
			<form method="post" name="form1" action="mkk_myenq_update_branch2.php">
...
?>
							<tr>
								<td bgcolor="#eeeeee" rowspan=2 width="20%">条件<?=$cno?></td>
...
?>
			...
			<input type="button" value="　戻る　" onclick="location.href='mkk_myenq_edit_branch.php?my_enq_no=<?=$my_enq_no?>'">
