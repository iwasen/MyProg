	...
	<tr>
		...
		<td width="778" align="center" valign="top">
			...
			<table border=0 cellspacing=2 cellpadding=3 width="90%" class="honbun2">
				<tr>
				  <td bgcolor="#ffffff" align="right" class="footer_text"><a href="#bottom">一番下へ▼</a><a name="top"></a></td>
			    </tr>
				<tr>
...
?>
							<tr>
								<td bgcolor="#eeeeee" width="15%">説明文</td>
								<td bgcolor="#ffeecc">
...
?>
							...
							<tr id="sel<?=$i?>">
								<td bgcolor="#ffeecc">
									<strong>選択肢（<?=MAX_PRO_SEL - 12?>個まで ※フリー回答／排他選択肢を加えた場合22個まで）</strong><br>
									...
									<div id="exf<?=$i?>"><input type="checkbox" name="ex_flag<?=$i?>" <?=value_checked(true, $question->ex_sno != 0)?>>排他選択肢を末尾につける（「この中にない」「特にない」など）<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;排他選択肢の文字列 <input type="text" name="ex_sel<?=$i?>" <?=value($question->sel_text[$question->ex_sno])?> size=50></div>								</td>
							</tr>
							<tr id="mtx<?=$i?>">
								<td bgcolor="#ffeecc">
												...
												<table class="honbun2">
													<tr>
														...
														<td>
															...
															※表側には「質問項目」、表頭には「選択肢」を設定してください。														</td>
													</tr>
												</table>											</td>
										</tr>
									</table>
									<div><input type="checkbox" name="dup_flag<?=$i?>" <?=value_checked('t', $question->dup_flag)?>>回答の重複を許さない</div>								</td>
							</tr>
							<tr id="na1<?=$i?>">
								<td bgcolor="#ffeecc">
...
?>
							<tr>
								<td colspan="2" bgcolor="#ffeecc">
									<input type="button" value="　質問を追加　" onclick="add_question()">								</td>
							</tr>
<?
}
?>
...
<table width="90%" border="0" cellspacing="0" cellpadding="5">
  <tr>
    <td align="right" class="footer_text"><a href="#top">一番上へ▲</a><a name="bottom"></a></td>
  </tr>
</table>
