...
<td width='232'><a href='" . $top_path . "index.php'><img src='" . $top_path . "images/common/logo.gif' alt='調査(リサーチ)ネットリサーチサービスのきかせて・net' width='232' height='57' border='0' /></a></td>
		...
		<table border='0' cellpadding='0' cellspacing='8' class='header_text'>
            <tr>
              <td colspan='5' align='right'><h1>ネットリサーチサービスならきかせて･net｜エージェントが調査設計、アンケート実施、調査結果レポート等の調査業務代行。</h1></td>
              </tr>
            <tr>
...
<a href='mk/kkstfrom/mk_contact.php'>".$menu[PG_CONTACT]." </td>
              <td width='1' bgcolor='#dbdbdb'><img src='" . $top_path . "images/common/spacer.gif' width='1' height='28' /></td>
              <td width='276' align='right'><img src='" . $top_path . "images/top/tel.gif' alt='お気軽にお電話ください03-5472-7903'></td>
            </tr>
        </table>
		<!-- ここまでヘッダー -->
		</td>
...
<tr> 
<td align='right' width='65'><a href='http://privacymark.jp' target='_blank'><img src='" . $top_path . "images/common/pmark_s.gif' alt='プライバシーマーク' width='75' height='80' /></a><br /><br />
</td>
<td valign='top' class='footer_text'><img src='" . $top_path . "images/common/spacer.gif' width='5' height='1' />Copyright 2006 <a href='http://www.xxxxxxx.co.jp/'>DO 
