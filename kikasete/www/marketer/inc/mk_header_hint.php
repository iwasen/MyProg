...
<head>
<title>$title</title>
<meta name='keywords' content='調査設計,シュミレーション,調査手法,実態調査,商品開発,ネットリサーチ,調査方法,マッピング,アウトプット,質問例,ケーススタディ'>
<meta name='description' content='調査設計シュミレーションツール。様々なケーススタディにあわせた調査手法で調査プランを把握。質問例文、アウトプット例など。'>
