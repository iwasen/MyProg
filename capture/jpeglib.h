...
struct jpeg_compress_struct {
  ...
  boolean optimize_coding;	/* TRUE=optimize entropy encoding pxxxs */
...
struct jpeg_decompress_struct {
   ...
   * high, space and time will be wasted due to unxxxessary data copying.
...
#define JMSG_LENGTH_MAX  200	/* recommended size of format_message buffer */
   ...
   */
  int msg_code;
#define JMSG_STR_Pxxx_MAX  80
  union {
    int i[8];
    char s[JMSG_STR_Pxxx_MAX];
  } msg_pxxx;
...
#define jpeg_destroy_compress	jDexxxompress
