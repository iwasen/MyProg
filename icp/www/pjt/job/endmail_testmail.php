...
for ($i = 0; $i < $nrow; $i++) {
	...
	// 配信先リスト設定
	send_mail_list($send_mail_id, $fetch->pm_mail_addr, $sub_seq);
...
<tr>
	<td width="10"><img src="../img/spacer.gif" width="10" height="30" border="0"></td>
	<td width="780" align="center"><a href="javascript:history.back()" title="終了メール設定更新に">終了メール設定更新に戻る</a></td>
	<td width="10"><img src="../img/spacer.gif" width="10" height="30" border="0"></td>
</tr>
</table>
<!-- 戻る -->
