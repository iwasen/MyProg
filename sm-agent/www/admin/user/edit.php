...
<table border=0 cellspacing=2 cellpadding=3 width="80%">
	...
	<tr>
		<td class="m1" width="20%">名前<?=MUST_ITEM?></td>
		<td class="n1">
			<input class="kanji" type="text" name="name1" size="40" <?=value($fetch->us_name1)?>> 姓<br>
			<input class="kanji" type="text" name="name2" size="40" <?=value($fetch->us_name2)?>> 名
		</td>
	</tr>
</table>
<br>
